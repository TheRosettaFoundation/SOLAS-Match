...
namespace  {
  ...
  class BannedLogin extends \DrSlump\Protobuf\Message {
    ...
    public $email_type = \EmailMessage\Type::BannedLogin;
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, '.BannedLogin');
      ...
      $f->default   = \EmailMessage\Type::BannedLogin;
