...
namespace  {
  ...
  class TaskArchived extends \DrSlump\Protobuf\Message {
    ...
    public $email_type = \EmailMessage\Type::TaskArchived;
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, '.TaskArchived');
      ...
      $f->default   = \EmailMessage\Type::TaskArchived;
