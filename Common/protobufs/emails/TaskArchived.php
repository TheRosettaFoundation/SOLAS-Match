...
// @@protoc_insertion_point(namespace:.SolasMatch.Common.Protobufs.Emails.TaskArchived)
 ...
 */
class TaskArchived extends \ProtocolBuffers\Message
{
  // @@protoc_insertion_point(traits:.SolasMatch.Common.Protobufs.Emails.TaskArchived)
  ...
  // @@protoc_insertion_point(properties_scope:.SolasMatch.Common.Protobufs.Emails.TaskArchived)
  ...
  public static function getDescriptor()
  {
    ...
    if (!isset($descriptor)) {
      ...
      $desc->addField(1, new \ProtocolBuffers\FieldDescriptor(array(
        ...
        "repeated" => false,
        "packable" => false,
        "default"  => \SolasMatch\Common\Protobufs\Emails\EmailMessage\Type::TaskArchived,
      )));
      ...
      // @@protoc_insertion_point(builder_scope:.SolasMatch.Common.Protobufs.Emails.TaskArchived)
