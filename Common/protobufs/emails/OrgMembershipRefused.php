...
namespace  {
  ...
  class OrgMembershipRefused extends \DrSlump\Protobuf\Message {
    ...
    public $email_type = \EmailMessage\Type::OrgMembershipRefused;
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, '.OrgMembershipRefused');
      ...
      $f->default   = \EmailMessage\Type::OrgMembershipRefused;
