...
class Email {
    ...
    static function get($socket,$length=1024){
    $send = '';
...
static function put($socket,$cmd,$length=1024){
    fputs($socket,$cmd."\r\n",$length);
}
...
//            self::put($SMTPIN,$cmd);
//            self::get($SMTPIN); // 220
//            if(false == stream_socket_enable_crypto($SMTPIN, true, STREAM_CRYPTO_METHOD_TLS_CLIENT)){
