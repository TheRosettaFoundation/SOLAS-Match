...
namespace  {
  ...
  class ArchivedTask extends \DrSlump\Protobuf\Message {
    ...
    public static function descriptor()
    {
      ...
      // OPTIONAL INT32 sourceLanguageCode = 8
      $f = new \DrSlump\Protobuf\Field();
      $f->number    = 8;
      ...
      // OPTIONAL INT32 targetLanguageCode = 9
      $f = new \DrSlump\Protobuf\Field();
      $f->number    = 9;
      ...
      // OPTIONAL INT32 sourceCountryCode = 10
      $f = new \DrSlump\Protobuf\Field();
      $f->number    = 10;
      ...
      // OPTIONAL INT32 targetCountryCode = 11
      $f = new \DrSlump\Protobuf\Field();
      $f->number    = 11;
