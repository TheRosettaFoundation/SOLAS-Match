    ...
    {/if}
        <div class="col-12 col-md-6 col-lg-4">
            <div class="card article-card h-100 border-0 rounded-3 overflow-hidden d-flex flex-column">
                <a href="{if empty($new['external_link'])}{urlFor name="content_display" options="user_id.{$new['id']"}/{else}{$new['external_link']}{/if}" class="d-block">
                ...
                <div class="card-body p-4 flex-grow-1">
                    ...
                    <a href="{if empty($new['external_link'])}{urlFor name="content_display" options="user_id.{$new['id']"}/{else}{$new['external_link']}{/if}" class="fs-5 fw-bold text-dark text-decoration-none article-title d-block">
                        {$new['title']}
                    </a>
                ...
                <div class="card-footer bg-white border-0 p-4 pt-0">
                    <a href="{if empty($new['external_link'])}{urlFor name="content_display" options="user_id.{$new['id']"}/{else}{$new['external_link']}{/if}" class="text-decoration-none fw-semibold d-flex align-items-center twb-core-blue">
                        Read Article &rarr;
                    </a>
                </div>
            </div>
