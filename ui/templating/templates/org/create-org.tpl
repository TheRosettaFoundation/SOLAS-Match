           ...
           {/if}
            <tr valign="top" align="center">
                ...
                <td width="50%">
                    ...
                    {if isset($org) && !empty($org->getHomePage())}
                ...
                <td width="50%">
                    ...
                    <textarea name='address' id='address' cols='40' rows='7' style="width: 80%">{if isset($org)}{TemplateHelper::uiCleanseNewlineAndTabs($org->getAddress())}{/if}</textarea>
