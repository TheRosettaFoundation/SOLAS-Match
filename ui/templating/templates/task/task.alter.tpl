                            ...
                            <tr style="overflow-wrap: break-word;">
                                ...
                                <td>                                            
                                    ...
                                    {elseif $status_id == TaskStatusEnum::COMPLETE}
                                        {if !empty($allow_download)}<a href="{urlFor name="home"}task/{$task_id}/download-task-latest-file/">{/if}{Localisation::getTranslation('common_complete')}{if !empty($allow_download)}</a>{/if}
                                    {/if}
                                </td>
                            </tr>
                        {/foreach}
