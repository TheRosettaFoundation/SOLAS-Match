        ...
        <table class="w-100 ">
           <tbody class="mx-4">
                ...
                <td class="ms-0 md:ms-4">
                    ...
                    <input class="form-control" type="text" name="word_count" id="word_count" maxlength="6" value="{$task->getWordCount()}" {if !($roles & ($SITE_ADMIN + $PROJECT_OFFICER + $VOLUNTEER_PO))}disabled{/if} style="width: 400px" />
                    ...
                    <input class="form-control" type="text" name="word_count_partner_weighted" id="word_count_partner_weighted" maxlength="6" value="{$task->get_word_count_partner_weighted()}" {if !($roles & ($SITE_ADMIN + $PROJECT_OFFICER + $VOLUNTEER_PO))}disabled{/if} style="width: 400px" />
