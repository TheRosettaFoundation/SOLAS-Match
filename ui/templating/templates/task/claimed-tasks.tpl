                        ...
                        {assign var="task_title" value=$task->getTitle()}
                         ...
                         <div class="d-flex justify-content-start mb-2 flex-wrap">
                             <div class="">
                                 ...
                                 <div><div class="process_deadline_utc d-flex mb-3 flex-wrap align-items-center text-muted" style="visibility: hidden"> {$deadline_timestamps[$task_id]}</div> or earlier, if possible</div>
                             </div>
                        </div>
