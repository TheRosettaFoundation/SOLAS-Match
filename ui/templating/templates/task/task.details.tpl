    ...
    <table class="table table-borderless ">
        ...
        <tbody class="fs-6">
           ...
           <div class="table-responsive">
            ...
            <tr>
                <td class="w-50">
                   <div class="border-bottom-4 border-primary"> {if !preg_match('/^Test.{4}$/', $task->getTitle())}<a href="https://community.translatorswb.org/t/{$discourse_slug}" class=" btn btn-sm btn-grayish" target="_blank"> Discuss </a>{/if}</div>
                </td>
