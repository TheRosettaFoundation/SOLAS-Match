        ...
        <tbody class="fs-6">
           ...
           <div class="table-responsive">
            ...
            <tr>
                ...
                <td class="w-50 d-flex ">
                    <div class="pb-1 bg-dark rounded-2">{if ($roles & ($SITE_ADMIN + $PROJECT_OFFICER + $COMMUNITY_OFFICER)) && !empty($matecat_url)}<a href="{$matecat_url}" class="btn btn-sm btn-grayish   text-white " target="_blank"> Job URL <img src="{urlFor name='home'}ui/img/url.svg" alt="url" /></a>{/if}</div>
                </td>
