    ...
    <header class="">
        ...
        <div class="container py-2">
                ...
                <div class="py-2" >
                    ...
                    <a  class="text-decoration-none link-body fw-bold"  href="/"> Home </a> <img src="{urlFor name='home'}ui/img/bread.svg" alt="arrow" class="mx-1" /<img src="{urlFor name='home'}ui/img/bread.svg" alt="arrow" class="mx-1" >
                    ...
                    <a class=" text-decoration-none link-body fw-bold" href="{urlFor name="task-claim-page" options="task_id.$task_id"}"> Claim </a>
                </div>
