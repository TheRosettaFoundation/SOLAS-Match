    ...
    <header class="">
        ...
        <div class="container py-2"> 
                ...
                <div class="py-2" >
                    ...
                    <a  class="text-decoration-none text-body fw-bold"  href="/"> Home </a> <img src="{urlFor name='home'}ui/img/bread.svg" alt="arrow" class="mx-1" /<img src="{urlFor name='home'}ui/img/bread.svg" alt="arrow" id="next" class="mx-1" />
        
                    <a   href="{urlFor name="task-view" options="task_id.$task_id"}" class="text-primaryDark fw-bold text-decoration-none"> Task </a> <img src="{urlFor name='home'}ui/img/bread.svg" alt="arrow" id="next" class="mx-1" />
         ...
         {if !empty($file_preview_path)}
          ...
          <div class="d-flex ">
                        ...
                        <img src="{urlFor name='home'}ui/img/print.svg" alt="print" id="print" class="mx-4 " />
                         ...
                         <a href="https://docs.google.com/viewer?url={$file_preview_path}&embedded=true"  download="{$file_preview_path}"  id="download-file"> <img src="{urlFor name='home'}ui/img/download.svg" id="downimg" alt="download" /> </a>
