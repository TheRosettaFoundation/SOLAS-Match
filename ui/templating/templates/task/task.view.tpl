                                 ...
                                 <div class="w-50" >
                                   <div class="fs-5 fw-bold w-50 mb-4 d-block d-md-none"> {Localisation::getTranslation('task_view_assign_label')}</div>
                                    ...
                                    {if !empty($list_qualified_translators)}
                                        <select  name="assignUserSelect" id="assignUserSelect" class="select mt-2 mb-4" >
                                            <option value="">...</option>
                                    ...
                                    <div class="w-50 mb-4">
                                        ...
                                        <input type="text" class="fs-6 mb-2" id='input' name="userIdOrEmailDenyList" placeholder="{Localisation::getTranslation('task_view_assign_placeholder')}"><br />
