    ...
    <header class="">
        ...
        <div class="container py-2"> 
                ...
                <div class="py-2" >
                    ...
                    <a  class="text-decoration-none text-body fw-bold"  href="/"> Home </a> <img src="{urlFor name='home'}ui/img/bread.svg" alt="arrow" class="mx-1" /<img src="{urlFor name='home'}ui/img/bread.svg" alt="arrow" class="next mx-1" />
        
                    <a   href="{urlFor name="task-view" options="task_id.$task_id"}" class="text-primaryDark fw-bold text-decoration-none"> Task </a> <img src="{urlFor name='home'}ui/img/bread.svg" alt="arrow" class="next2 mx-1" />
