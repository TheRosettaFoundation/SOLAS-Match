                               ...
                               <div class="d-flex p-2 fs-6 mt-2">
                                 <div class="w-50" >
                                   <div class="fs-5 fw-bold w-50 mb-4 d-block d-md-none"> {Localisation::getTranslation('task_view_assign_label')}</div>
                                    ...
                                    <input class=" form-control form-control-sm fs-6 border-1" type="email" name="userIdOrEmail" placeholder="{Localisation::getTranslation('task_view_assign_placeholder')}">
                                    {/if}
                                    {if !empty($list_qualified_translators)}
                                        <select class="form-select form-select-sm" name="assignUserSelect" id="assignUserSelect"">
                                            <option value="">...</option>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class=" form-control form-control-sm  fs-6 border-1 mb-2" name="userIdOrEmailDenyList" placeholder="{Localisation::getTranslation('task_view_assign_placeholder')}"><br />
