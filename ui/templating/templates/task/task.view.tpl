    ...
    <header class="">
        ...
        <div class="container py-2">
                ...
                <div class="py-2" >
                    ...
                    <a  class="text-decoration-none link-secondary fw-bold"  href="/"> Home </a> <img src="{urlFor name='home'}ui/img/bread.svg" alt="arrow" class="mx-1" /<img src="{urlFor name='home'}ui/img/bread.svg" alt="arrow" class="mx-1" >
                    ...
                    <a class=" text-decoration-none link-secondary fw-bold" href="{urlFor name="task-claim-page" options="task_id.$task_id"}"> Claim </a>
                </div>
          ...
          <div class="d-flex  flex-wrap justify-content-between">
             ...
             <div class="d-flex mt-2 mt-md-0">
                  ...
                  {if ($roles & ($SITE_ADMIN + $PROJECT_OFFICER + $NGO_ADMIN + $NGO_PROJECT_OFFICER))}
                    <a href="{urlFor name="task-alter" options="task_id.$task_id"}" class='btn btn-primaryDark shadow text-white me-2'">
                ...
                <div class=" col-sm-12  col-md-8 "> 
                         ...
                         {include file="task/task.details.tpl"} 
                            ...
                            <div class="bg-body p-2 border-secondary rounded-3 mt-2">
                              <div class="d-none d-md-flex flex-wrap justify-content-between align-items-center p-2">
                               ...
                               <div class="d-block d-md-flex  p-2 fs-6 mt-2">
                                 <div class="w-md-50" >
                                   <div class="fs-5 fw-bold w-50 mb-4 d-block d-md-none"> {Localisation::getTranslation('task_view_assign_label')}</div>
                                    ...
                                    <input class="form-control-sm  w-25 fs-6 border-1" type="email" name="userIdOrEmail" placeholder="{Localisation::getTranslation('task_view_assign_placeholder')}">
                                    {/if}
                                    {if !empty($list_qualified_translators)}
                                        <select class="form-select-sm  w-25  mt-2 mb-4 fs-6 border-1" name="assignUserSelect" id="assignUserSelect"">
                                            <option value="">...</option>
                                    ...
                                    <div class="w-md-50 mb-4">
                                        ...
                                        <input type="text" class="form-control-sm  w-25 fs-6 border-1 mb-2" name="userIdOrEmailDenyList" placeholder="{Localisation::getTranslation('task_view_assign_placeholder')}"><br />
