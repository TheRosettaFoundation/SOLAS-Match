    ...
    <header class="">
        ...
        <div class="container py-2">
                ...
                <div class="py-2" >
                    ...
                    <a  class="text-decoration-none link-underline-secondary link-underline-opacity-0"  href="/"> Home </a> <img src="{urlFor name='home'}ui/img/bread.svg" alt="arrow" class="mx-1" /<img src="{urlFor name='home'}ui/img/bread.svg" alt="arrow" class="mx-1" >
                    ...
                    <a class="text-decoration-none text-secondary-subtle" href="{urlFor name="task-claim-page" options="task_id.$task_id"}"> Claim </a>
                </div>
                               ...
                               <div class="d-flex justify-content-between p-2 fs-6">
                                 <div>
                                  ...
                                  <form id="assignTaskToUserForm" method="post" action="{urlFor name="task-view" options="task_id.$task_id"}" onsubmit="return confirm('{Localisation::getTranslation("task_view_assign_confirmation")}');">
                                    ...
                                    <input class="form-control-sm w-50 fs-6 " type="text" name="userIdOrEmail" placeholder="{Localisation::getTranslation('task_view_assign_placeholder')}"><br />
                                    {/if}
