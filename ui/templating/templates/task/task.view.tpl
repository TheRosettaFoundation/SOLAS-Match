         ...
         {if !empty($file_preview_path)}
          ...
          <div class="d-flex ">
                        ...
                        <img src="{urlFor name='home'}ui/img/print.svg" alt="print" id="print" class="mx-4 " />
                         ...
                         <a href="https://docs.google.com/viewer?url={$file_preview_path}&embedded=true"  download="document.pdf"  id="download-file"> <img src="{urlFor name='home'}ui/img/download.svg" alt="download" /> </a>
