...
<div class="container py-2">
         ...
         <div class="py-2" >
            ...
            <a   href="{urlFor name="task-claim-page" options="task_id.$task_id"}" class="text-primaryDark fw-bold text-decoration-none"> Task </a> <img src="{urlFor name='home'}ui/img/bread.svg" alt="arrow" class="mx-1" >
