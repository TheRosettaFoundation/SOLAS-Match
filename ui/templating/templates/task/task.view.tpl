                         ...
                         {include file="task/task.details.tpl"} 
                            ...
                            <div class="bg-body p-2 border-secondary rounded-3 mt-2">
                              <div class="d-none d-md-flex flex-wrap justify-content-between align-items-center p-2">
                               ...
                               <div class=" d-block d-md-flex flex-wrap justify-content-between p-2 fs-6 mt-2">
                                 <div  class="w-auto">
                                   <div class="fs-5 fw-bold w-50 mb-4 d-block d-md-none"> {Localisation::getTranslation('task_view_assign_label')}</div>
                                    ...
                                    <div class="w-auto">
                                         ...
                                         <div class="fs-5 fw-bold w-50 d-block d-md-none mb-4"> Remove a user from deny list for this task:</div>
