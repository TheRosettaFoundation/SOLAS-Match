                                 ...
                                 <div class="" >
                                   <div class="fs-5 fw-bold w-50 mb-4 d-block d-md-none"> {Localisation::getTranslation('task_view_assign_label')}</div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class=" form-control form-control-sm  fs-6  mb-2" name="userIdOrEmailDenyList" placeholder="{Localisation::getTranslation('task_view_assign_placeholder')}"><br />
