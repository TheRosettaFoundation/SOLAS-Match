      ...
      <div class="card-body p-4">
        <div class="d-flex flex-column flex-lg-row align-items-start align-items-lg-center justify-content-between gap-3">
          <div class="d-flex align-items-start gap-3">
            ...
            <div>
              <div><a href="{$siteLocation}org/{$org_id}/profile" class="task_tooltip" style="text-decoration: none;"><span class="soft-muted small">{TemplateHelper::uiCleanseHTML($org_name)}<span class="task_tooltiptext">Project that this task belongs to</span></span></a></div>
