...
<header class="">
    ...
    <div class="container py-2">
            ...
            <div class="py-2" >
                  <a  class="text-decoration-none link-secondary fw-bold"  href="/"> Home </a> <img src="{urlFor name='home'}ui/img/bread.svg" alt="arrow" class="mx-1" >
    
                <a  href="{urlFor name="task-view" options="task_id.$task_id"}"  class="text-decoration-none link-secondary fw-bold"> Task </a> <img src="{urlFor name='home'}ui/img/bread.svg" alt="arrow" class="mx-1" >
