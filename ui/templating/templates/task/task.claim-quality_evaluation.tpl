     ...
     <div class="d-md-flex justify-content-between ">
                ...
                <div class="d-flex flex-column justify-content-between  p-4 >
                     ...
                     <div >
                        ...
                        <h3 class="mb-4 fw-bold">Do you want to quality evaluate this file?</h4>
                        
                        <ol>
                            <li>Will you have enough time to quality evaluate this file? Check how long the file is.</li>
                            <li>
                                {sprintf('Do you think you are capable of quality evaluating a file in <strong>%s?</strong>', {TemplateHelper::getLanguage($task->getTargetLocale())})}
                            </li>
                            ...
                            <li>
                                {sprintf(Localisation::getTranslation('task_claim_warning_kato'), {Localisation::getTranslation('task_claim_view_on_kato')}, {Localisation::getTranslation('common_download_file')}, 'Yes, I promise I will quality evaluate this file')}
                            </li>
                            {/if}
                            {if !empty($memsource_task) || empty($allow_download)}
                            <li>
                                Also please note that you must wait for translation/revision to be complete (100% translated/revised) before starting quality evaluation.
                            </li>
                            {/if}
                        </ol>
