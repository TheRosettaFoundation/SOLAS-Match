                        ...
                        <div class="card bg-light-mariam custom-card p-4 card-border-top-accent">
                            <div class="d-flex justify-content-between align-items-center mb-4 border-bottom pb-3">
                                ...
                                <div class="d-flex gap-2">
                                    ...
                                    {if $roles&($SITE_ADMIN + $PROJECT_OFFICER + $VOLUNTEER_PO) || in_array($org_id, $ORG_EXCEPTIONS) && $roles&($NGO_ADMIN + $NGO_PROJECT_OFFICER)}
                            ...
                            <div class="row g-0 py-3 border-bottom align-items-center">
                                ...
                                <div class="col-11 col-md-4">
                                    <a href="{urlFor name="project-view" options="project_id.{$project_id}"}" class="text-decoration-none fw-bold text-dark-mariam d-block">
                                        {if mb_strlen($project['title']) > 28}
                                            {assign var="project_title" value=TemplateHelper::uiCleanseHTMLNewlineAndTabs(mb_substr($project['title'], 0, 28))}
