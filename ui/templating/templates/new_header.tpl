            ...
            <ul class="navbar-nav   d-flex align-items-center ">
                ...
                <ul class="dropdown-menu" aria-labelledby="hoverDropdown">
                   {if Settings::get('site.forum_enabled') == 'y'}
                    ...
                    {* {/if} *}
                    {* {if !isset($site_admin)} *}
                    <li {if isset($current_page) && $current_page == 'faq'}" {/if}  > <a  href="https://communitylibrary.translatorswb.org/login" target="_blank" class="dropdown-item py-2 fw-bold"><div><span class="mx-2">💬</span> Community Library</div>
