        ...
        <table width="100%">
            <tr align="center">
                <td>
                    ...
                    <input type="text" maxlength="6" value="{$project->getWordCount()}" style="width: 400px;  margin-bottom: 20px" name="wordCountInput" id="wordCountInput" {if !($roles & ($SITE_ADMIN + $PROJECT_OFFICER + $VOLUNTEER_PO))}disabled{/if} />
