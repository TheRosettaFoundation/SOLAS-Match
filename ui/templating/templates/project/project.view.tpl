    ...
    {if $roles & ($SITE_ADMIN + $PROJECT_OFFICER + $COMMUNITY_OFFICER + $NGO_ADMIN + $NGO_PROJECT_OFFICER)}
       ...
       <div>
        ...
        {if $roles & ($SITE_ADMIN + $PROJECT_OFFICER)}
            ...
            <li>
                ...
                <li>
                    ...
                    <form id="status_as_unclaimed"method="post" class="dropdown-item" action="{urlFor name="project-view" options="project_id.$project_id"}" >
            ...
            <li>
                ...
                <form id="cancel" class="dropdown-item" method="post" action="{urlFor name="project-view" options="project_id.$project_id"}" style="margin-bottom: 2px;">
            ...
            <li >
                ...
                <form id="ready_payment" class="dropdown-item" method="post" action="{urlFor name="project-view" options="project_id.$project_id"}" style="margin-bottom: 2px;">
            ...
            <form id="pending_documentation" class="dropdown-item" method="post" action="{urlFor name="project-view" options="project_id.$project_id"}" style="margin-bottom: 2px;">
            ...
            <form id="tasks_settled" class="dropdown-item" method="post" action="{urlFor name="project-view" options="project_id.$project_id"}" >
        ...
        {if $roles & ($SITE_ADMIN + $PROJECT_OFFICER + $NGO_ADMIN + $NGO_PROJECT_OFFICER)}
            ...
            <form id="publish_selected_tasks" class="btn btn-primary"  method="post" action="{urlFor name="project-view"  options="project_id.$project_id"}" >
             ...
             <form  class="btn btn-primary" id="unpublish_selected_tasks" method="post" action="{urlFor name="project-view" options="project_id.$project_id"}" >
                                ...
                                <td> <input type="checkbox" name="select_task" value="{$task->getId()}" data-task-type="{$task->getTaskType()}" data-lang="{$languageCountry|replace:',':'_'}" data-paid="{$get_paid_for_project[$task_id]}" data-payment-status="{$get_payment_status_for_project[$task_id]['payment_status']}" /> </td>
                                    ...
                                    {else}
                                        <span data-toggle="tooltip" data-placement="right" title="Cancel" >
                                            <a class="btngray cancel" data-toggle="modal"  id="cancel" href="#cancelmodal" role="button" data-task-id="{$task->getId()}" data-cancelled="1">
