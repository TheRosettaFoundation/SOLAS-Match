              ...
              <div class="menu_open btn btn-primary text-white  cursor-pointer"  >
                    ...
                    {if $roles & ($SITE_ADMIN + $PROJECT_OFFICER)}
                        ...
                        <form id="tasks_as_unpaid" class="d-flex flex-column btn btn-small" method="post" action="{urlFor name="project-view" options="project_id.$project_id"}" >
                            <a class="form_action text-body p-1 fs-6 text-decoration-none" onclick="$('#tasks_as_unpaid').submit();" >
                    ...
                    {if $roles & ($SITE_ADMIN + $PROJECT_OFFICER) || in_array($project->getOrganisationId(), $ORG_EXCEPTIONS) && $roles & ($NGO_ADMIN + $NGO_PROJECT_OFFICER)}
                        <form id="status_as_unclaimed" class="d-flex flex-column btn btn-small" method="post" action="{urlFor name="project-view" options="project_id.$project_id"}" >
                            <a class="form_action text-body p-1 fs-6 text-decoration-none" onclick="$('#status_as_unclaimed').submit();" >
                        ...
                        <form id="status_as_waiting" class="d-flex flex-column btn btn-small" method="post" action="{urlFor name="project-view" options="project_id.$project_id"}" >
                            <a class="form_action p-1 text-body fs-6 text-decoration-none" onclick="$('#status_as_waiting').submit();">
                        ...
                        <form id="complete_selected_tasks" class="d-flex flex-column btn btn-small" method="post" action="{urlFor name="project-view" options="project_id.$project_id"}" >
                            <a class="form_action text-body p-1 fs-6 text-decoration-none" onclick="$('#complete_selected_tasks').submit();">
                        ...
                        <form id="uncomplete_selected_tasks" class=" d-flex flex-column btn btn-small" method="post" action="{urlFor name="project-view" options="project_id.$project_id"}" >
                            <a class="form_action p-1 text-body fs-6 text-decoration-none" onclick="$('#uncomplete_selected_tasks').submit();">
                        ...
                        <a class="form_action p-1 text-body fs-6 text-decoration-none open-cancel-modal p-1" data-bs-toggle="modal" data-id="1" href="#cancelmodal" role="button" data-cancelled="1">
                        ...
                        <a class="form_action p-1 text-body fs-6 text-decoration-none p-1" onclick="$('#cancel').submit();"   data-id="0" role="button" data-cancelled="0">
                    ...
                    {if $roles & ($SITE_ADMIN + $PROJECT_OFFICER)}
                        ...
                        <a class="form_action p-1 text-body fs-6 text-decoration-none open-ponum-modal"  data-bs-toggle="modal" href="#ponummodal" role="button">
                        ...
                        <a class="form_action p-1 text-body fs-6 text-decoration-none" onclick="$('#ready_payment').submit();" style="color:#000000;" role="button">
                        ...
                        <a class="form_action  p-1 text-body fs-6 text-decoration-none" onclick="$('#pending_documentation').submit();" style="color:#000000;" role="button">
                        ...
                        <a class="form_action  p-1 text-body fs-6 text-decoration-none" onclick="$('#tasks_settled').submit();" style="color:#000000;" role="button">
