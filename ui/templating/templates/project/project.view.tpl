  ...
  <div class="bg-body p-2 border-secondary rounded-top-3 mt-4 flex-grow-1 ms-md-2">
    ...
    <div class="menu_open btn btn-primary text-white  cursor-pointe mb-4"  >
          ...
          {if $roles & ($SITE_ADMIN + $PROJECT_OFFICER + $NGO_ADMIN + $NGO_PROJECT_OFFICER)}
              ...
              <form id="unpublish_selected_tasks" class="bg-light-subtle d-flex flex-column justify-content-center form_action me-2" method="post" action="{urlFor name="project-view" options="project_id.$project_id"}" >
          ...
          {if $roles & ($SITE_ADMIN + $PROJECT_OFFICER)}
              <form id="tasks_as_paid" class="bg-light-subtle d-flex flex-column  justify-content-center form_action me-2" method="post" action="{urlFor name="project-view" options="project_id.$project_id"}" >
              ...
              <form id="tasks_as_unpaid" class="bg-light-subtle d-flex flex-column justify-content-center form_action me-2" method="post" action="{urlFor name="project-view" options="project_id.$project_id"}" >
              ...
              <form id="publish_native_users" class="bg-light-subtle d-flex flex-column justify-content-center form_action me-2" method="post" action="{urlFor name="project-view" options="project_id.$project_id"}" >
          ...
          <form id="publish_language_match" class="bg-light-subtle d-flex flex-column justify-content-center form_action me-2" method="post" action="{urlFor name="project-view" options="project_id.$project_id"}" >
      ...
      <form id="publish_all" class="bg-light-subtle d-flex flex-column justify-content-center form_action me-2" method="post" action="{urlFor name="project-view" options="project_id.$project_id"}" >
        ...
        {if isset($sesskey)}<input type="hidden" name="sesskey" value="{$sesskey}" />{/if}
          ...
          {if $roles & ($SITE_ADMIN + $PROJECT_OFFICER) || in_array($project->getOrganisationId(), $ORG_EXCEPTIONS) && $roles & ($NGO_ADMIN + $NGO_PROJECT_OFFICER)}
              <form id="status_as_unclaimed" class="bg-light-subtle d-flex flex-column justify-content-center form_action me-2" method="post" action="{urlFor name="project-view" options="project_id.$project_id"}" >
              ...
              <form id="status_as_waiting" class="bg-light-subtle d-flex flex-column justify-content-center form_action me-2" method="post" action="{urlFor name="project-view" options="project_id.$project_id"}" >
              ...
              <form id="complete_selected_tasks" class="bg-light-subtle d-flex flex-column justify-content-center form_action me-2" method="post" action="{urlFor name="project-view" options="project_id.$project_id"}" >
              ...
              <form id="uncomplete_selected_tasks" class="bg-light-subtle d-flex flex-column justify-content-center form_action me-2" method="post" action="{urlFor name="project-view" options="project_id.$project_id"}" >
              ...
              <div class="bg-light-subtle d-flex flex-column justify-content-center form_action me-2">
              ...
              <form id="cancel" class="bg-light-subtle d-flex flex-column justify-content-center form_action me-2" method="post" action="{urlFor name="project-view" options="project_id.$project_id"}" style="margin-bottom: 2px;">
          ...
          {if $roles & ($SITE_ADMIN + $PROJECT_OFFICER)}
              ...
              <form id="ready_payment" class="bg-light-subtle d-flex flex-column justify-content-center form_action me-2" method="post" action="{urlFor name="project-view" options="project_id.$project_id"}" style="margin-bottom: 2px;">
              ...
              <form id="pending_documentation" class="bg-light-subtle d-flex flex-column justify-content-center form_action me-2" method="post" action="{urlFor name="project-view" options="project_id.$project_id"}" style="margin-bottom: 2px;">
              ...
              <form id="tasks_settled" class="bg-light-subtle d-flex flex-column justify-content-center form_action me-2" method="post" action="{urlFor name="project-view" options="project_id.$project_id"}" >
