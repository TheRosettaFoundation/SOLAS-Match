...
<section class=" bg-light-subtle"> 
  ...
  <div class="bg-body p-2 border-secondary rounded-top-3 mt-4 flex-grow-1 ms-md-2">
    ...
    {if $roles & ($SITE_ADMIN + $PROJECT_OFFICER + $COMMUNITY_OFFICER + $NGO_ADMIN + $NGO_PROJECT_OFFICER)}
        ...
        {if $roles & ($SITE_ADMIN + $PROJECT_OFFICER + $NGO_ADMIN + $NGO_PROJECT_OFFICER)}
            <form id="publish_selected_tasks" class="d-flex flex-column"  method="post" action="{urlFor name="project-view" options="project_id.$project_id"}" >
                <a class="flex-fill" onclick="$('#publish_selected_tasks').submit();" style="color:#000000;margin-right:65px;">
