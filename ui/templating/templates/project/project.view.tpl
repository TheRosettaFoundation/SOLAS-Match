...
{if $roles & ($SITE_ADMIN + $PROJECT_OFFICER + $COMMUNITY_OFFICER + $NGO_ADMIN + $NGO_PROJECT_OFFICER)}
    ...
    {else}
                  <span data-bs-toggle="tooltip" data-bs-placement="right" data-bs-html="true" data-bs-title="This is grayed out because you have no eligible <strong>Organization members</strong> and so task will be available to the <strong>Full TWB Community</strong>.">
    {/if}
