                                        ...
                                        {if $status_id == TaskStatusEnum::WAITING_FOR_PREREQUISITES}
                                            <span>{Localisation::getTranslation('common_waiting')}</span> <br>
                                             ...
                                             {if $get_payment_status_for_project[$task_id]['native_matching'] == 0} 
                                              ...
                                              <span><img src="{urlFor name='home'}ui/img/Native lm.svg" alt="check" >  Matching Native Language</span> 
                                              {elseif $get_payment_status_for_project[$task_id]['native_matching'] == 2}
                                              <span> <img src="{urlFor name='home'}ui/img/Native lcm.svg" alt="check" > Matching Native Language and Country</span> 
                                            {/if}
                                            </div>
