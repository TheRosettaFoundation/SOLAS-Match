...
<div class="container py-4" style="max-width: 800px;">
    <a href="{$siteLocation}content_list{$type}/" class="text-decoration-none fw-medium transition-colors mb-3 d-inline-flex align-items-center twb-core-blue">
        &larr; Back to {if $type == 2}Resources{else}News{/if} Archive
    </a>
