                    ...
                    function displayTasks(pages){
                     ...
                     try{
                        ...
                        for (const item of parsed.tasks) {
                            ...
                            <div class="text-muted  " > Due by <strong> <div class="mx-2 d-flex align-items-center"> ${ time[0] } </div>  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#f89406" class="bi bi-clock" viewBox="0 0 16 16" class="mx-1">
