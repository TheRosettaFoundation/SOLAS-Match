                ...
                <footer>
                      ...
                      <div class="bg-primary d-flex justify-content-between  flex-wrap text-white  mt-4 py-5">
                        ...
                        <div class="d-md-flex wrap"> 
                           ...
                           <div class ="mx-md-2  mx-xs-5"> <a href="https://facebook.com/translatorswithoutborders" target ="_blank"> <img alt="" src="{urlFor name='home'}ui/img/facebook.svg" /> </a></div>
                           <div class ="mx-md-2 mx-xs-5">  <a href="https://twitter.com/translatorswithoutborders" target ="_blank"> <img alt="" src="{urlFor name='home'}ui/img/x.svg" /> </a></div>
                            <div class ="mx-md-2 mx-xs-5">  <a href="https://www.youtube.com/user/TranslatorsWB" target ="_blank"> <img alt="" src="{urlFor name='home'}ui/img/youtube.svg" /> </a> </div>
                            <div class ="mx-md-2 mx-xs-5">  <a href=""https://linkedin.com/company/translators-without-borders" target ="_blank"> <img alt="" src="{urlFor name='home'}ui/img/linkdin.svg" /> </a></div>
