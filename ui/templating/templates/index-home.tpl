    ...
    <div class="col-sm-12 col-md-8 col-lg-9">
                        ...
                        {/if}
                            <div class="d-flex justify-content-between">
                                <div>
                                        ...
                                        <span class="fs-5 bg-primary border-2 border-primary opacity-75 rounded-circle d-inline-block px-2 text-white align-self-start"> ? </span> 
                                        </div>
            ...
            <ul class=" flex-row d-flex justify-content-center list-unstyled">
                    ...
                    {for $page=1 to $count}
                            ...
                            <li class="m-3 border border-dark-subtle rounded-3 px-2">
                            <a class="page-link" href="{urlFor name="$url_nam" options="page_no.$count|tt.$selectedTaskType|sl.$selectedSourceLanguageCode|tl.$selectedTargetLanguageCode "}">{$page}</a></li>
                    {/for}
                    <li class="m-3 border border-dark-subtle rounded-3 px-2">
