                            ...
                            <div class="d-flex justify-content-between mb-2 ">
                                <div class="">
                                        ...
                                        <div class="d-flex mt-2 mb-3 ">
                                            <button class="rounded-5 bg-greenish border border-2  border-greenBorder border-opacity-10 ">  <span class="fs-6 p-1 text-white fw-bold align-middle">{TaskTypeEnum::$enum_to_UI[$type_id]['type_text']} </span> </button>
                                                {if $task->getWordCount()}
                                                <button type="button" class=" ms-1 rounded-5  bg-quartenary border border-2 border-quartBorder border-opacity-10 "><div class="fs-6 p-1 text-white fw-bold align-middle"> {Localisation::getTranslation('common_word_count')}: <strong>{$task->getWordCount()}</strong> </div> </button>
                                                {/if}
