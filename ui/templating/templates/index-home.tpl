	                        ...
	                        <tr>
	                            <td>
	                                <select name="taskTypes" id="taskTypes">
                                      ...
                                      <option value="6" {if ($selectedTaskType === 6)}selected="selected"{/if}>Approval</option>
	                                 </select>
	                            </td>
	                            <td>
                ...
                {for $count=0 to $itemsPerScrollPage-1}
                    ...
                    <div class="ts-task">
                        ...
                        {/if}
                            ...
                            <p>
                                {Localisation::getTranslation('common_type')}: <span class="label label-info" style="background-color: {TaskTypeEnum::$enum_to_UI[$type_id]['colour']}">{TaskTypeEnum::$enum_to_UI[$type_id]['text']}</span>
                            </p>
                            <p>
