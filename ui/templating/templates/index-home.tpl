    ...
    <div class="col-sm-12 col-md-8 col-lg-9">
            ...
            <div class="d-flex justify-content-end align-items-center mb-3">  <span class ="m-2 d-inline-block" >Sort By : </span>
                     ...
                     <div class="">
                                        ...
                                        <select name="sorttype" ID="sorttype" class="form-select recents">
                                ...
                                <div class="">
                                        ...
                                        <div class="d-flex mt-2 mb-3 ">
                                         ...
                                         {if TaskTypeEnum::$enum_to_UI[$type_id]['source_and_target']}
                                            ...
                                            <div class="process_deadline_utc d-flex justify-content-between align-items-center px-1" style="visibility: hidden">{$deadline_timestamps[$task_id]}</div>
