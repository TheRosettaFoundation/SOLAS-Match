    ...
    <div class="col-sm-12 col-md-8 col-lg-9">
            ...
            <ul class="flex-row d-flex justify-content-center list-unstyled flex-wrap text-secondary pagination mt-1 mt-md-0">
                    ...
                    {/if}    
                     ...
                     <li class="mx-2 border border-dark-subtle rounded-3 py-1 px-2 mt-1 mt-md-0" >
                    ...
                    <li class="mx-2  border border-dark-subtle rounded-3 mt-1 mt-md-0 py-1 px-2" >
                            <a class="text-decoration-none link-body-emphasis fs-6" id="previous" href="{urlFor name="$url_nam" options="page_no.$paged|tt.$selectedTaskType|sl.$selectedSourceLanguageCode|tl.$selectedTargetLanguageCode"}">PREVIOUS</a></li>
                    ...
                    {/for}
                    <li class="mx-2  border border-dark-subtle mt-1 mt-md-0 rounded-3 py-1 px-2  ">
                            <a class=" text-decoration-none link-body-emphasis fs-6" id="next" href="{urlFor name="$url_nam" options="page_no.$paged|tt.$selectedTaskType|sl.$selectedSourceLanguageCode|tl.$selectedTargetLanguageCode"}">NEXT</a></li> 
                     <li class="mx-2  border border-dark-subtle mt-1 mt-md-0 rounded-3 py-1 px-2 " >
