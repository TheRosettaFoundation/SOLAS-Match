...
<div class="d-flex row justify-content-between ">
    ...
    <div class="col-sm-12 col-md-8 col-lg-9">
            ...
            <ul class=" flex-row d-flex justify-content-center list-unstyled flex-wrap text-secondary">
                    ...
                    {/for}
                    <li class="m-3 border border-dark-subtle rounded-3 py-1 px-2 ">
                            <a class="page text-decoration-none" id="next" href="{urlFor name="$url_nam" options="page_no.$paged|tt.$selectedTaskType|sl.$selectedSourceLanguageCode|tl.$selectedTargetLanguageCode"}">NEXT</a></li> 
                     <li class="m-3 border border-dark-subtle rounded-3 py-1 px-2" >
