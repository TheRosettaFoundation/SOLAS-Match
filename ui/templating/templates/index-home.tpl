    ...
    <div class="col-sm-12 col-md-8 col-lg-9 mt-4">
            ...
            <ul class="flex-row d-flex justify-content-center list-unstyled flex-wrap text-secondary pagination mt-1 mt-md-0">
                    ...
                    {for $page=1 to $count}
                            ...
                            <li {if $page==1 } class="mx-2 bg-primary border border-dark-subtle mt-1 mt-md-0 rounded-3 py-0 px-1 listPage text-primary" {else} class="mx-2 border border-dark-subtle mt-1 mt-md-0 rounded-3 py-0 px-2 listPage" {/if}>
