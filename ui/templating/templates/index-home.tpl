    ...
    <div class=" col-sm-12 col-md-4 col-lg-3 ">
        ...
        <form  method="post" action="{urlFor name="org-search"}" accept-charset="utf-8" class="needs-validation" novalidate> 
            ...
            <div class="d-flex mb-3 ">
             ...
             <input type="text" class=" flex-grow-1 flex-shrink-1 rounded-start-2 border border-1 border-light-subtle px-2 py-1 "  style="outline:none ;" name="search_name" id="search_name" placeholder= "search organizations"> 
