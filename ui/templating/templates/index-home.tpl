...
<div class="d-flex row justify-content-between ">
    ...
    <div class="col-sm-12 col-md-8 col-lg-9">
                            ...
                            <div class="d-flex justify-content-between mb-2 ">
                                <div class="">
                                        <div class="fw-bold fs-4  d-flex align-items-center bg-secondary">
                                            <div id="task-{$task_id}" href="{$siteLocation}task/{$task_id}/view" class="text-primary ">{TemplateHelper::uiCleanseHTMLNewlineAndTabs($task_title)} </div>
                                            <div class=" "> <img src="{urlFor name='home'}ui/img/question.svg" alt="question_Img" /></div> 
                                        </div>

                                        <div class="d-flex mt-2 mb-3 ">
                                            <button class="rounded-5 bg-greenish border border-2  border-greenBorder border-opacity-25">  <span class="fs-6 p-1 text-white fw-bold align-middle">{TaskTypeEnum::$enum_to_UI[$type_id]['type_text']} </span> </button>
                                                {if $task->getWordCount()}
                                                <button type="button" class=" ms-1 rounded-5  bg-quartenary border border-2 border-quartBorder border-opacity-25 "><div class="fs-6 p-1 text-white fw-bold align-middle"> {Localisation::getTranslation('common_word_count')}: <strong>{$task->getWordCount()}</strong> </div> </button>
                                                {/if}
                                         ...
                                         {if TaskTypeEnum::$enum_to_UI[$type_id]['source_and_target']}
                                            ...
                                            <div class="process_deadline_utc d-flex align-items-center px-1" style="visibility: hidden">{$deadline_timestamps[$task_id]}</div>
            ...
            <ul class=" flex-row d-flex justify-content-center list-unstyled flex-wrap text-secondary">
