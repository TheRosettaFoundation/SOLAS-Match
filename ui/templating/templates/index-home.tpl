    ...
    <div class="col-sm-12 col-md-8 col-lg-9">
            ...
            <ul class=" flex-row d-flex justify-content-center list-unstyled flex-wrap">
                    ...
                    <li class="m-3 border border-dark-subtle rounded-3 px-3" >
                            <a class="previous" id="" href="{urlFor name="$url_nam" options="page_no.$paged|tt.$selectedTaskType|sl.$selectedSourceLanguageCode|tl.$selectedTargetLanguageCode"}">previous</a></li>
                    ...
                    {/for}
                    <li class="m-3 border border-dark-subtle rounded-3 px-2">
                            <a class="next" id="" href="{urlFor name="$url_nam" options="page_no.$paged|tt.$selectedTaskType|sl.$selectedSourceLanguageCode|tl.$selectedTargetLanguageCode"}">next</a></li> 
                     <li class="m-3 border border-dark-subtle rounded-3 px-2" >
