                ...
                {for $count=0 to $itemsPerScrollPage-1}
                    ...
                    <div class="d-flex justify-content-between mb-4 bg-body-tertiary p-3 rounded-3"  >
                       <div class=" w-100">
                        ...
                        <div  id="task_{$task_id}">
                        {/if}
                            <div class="d-flex justify-content-between mb-2 border border-3 border-greenBorder ">
                                <div class="">
                                        ...
                                        <div class="d-flex mt-2 mb-3 ">
                                            <button class="rounded-5 bg-greenish border border-greenish opacity-75  border-5   ">  <span class="fs-6 p-1 text-white fw-bold align-middle">{TaskTypeEnum::$enum_to_UI[$type_id]['type_text']} </span> </button>
                                                {if $task->getWordCount()}
                                                <button type="button" class=" ms-1 rounded-5   bg-quartenary border border-5 border-quartenary border-opacity-75 "><div class="fs-6 p-1 text-white fw-bold align-middle"> {Localisation::getTranslation('common_word_count')}: <strong>{$task->getWordCount()}</strong> </div> </button>
                                                {/if}
