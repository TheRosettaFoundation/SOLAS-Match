                            ...
                            <div class="d-flex justify-content-between mb-2 flex-wrap">
                                <div class="">
                                        ...
                                        <div class="d-flex mt-2 mb-3 ">
                                            <span class=" badge rounded-pill bg-greenish border border-2 text-white text-uppercase border-greenBorder border-opacity-25 fs-7 font-bold" style="background-color:{TaskTypeEnum::$enum_to_UI[$type_id]['colour']}">  {TaskTypeEnum::$enum_to_UI[$type_id]['type_text']} </span>
