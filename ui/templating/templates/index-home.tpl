                       ...
                       <div>
                        ...
                        {/if}
                            ...
                            <div class="d-flex mt-4 mb-1">
                              <div class="p-1 rounded-3  bg-tagGreen "> {TaskTypeEnum::$enum_to_UI[$type_id]['type_text']}  </div>
                                {if $task->getWordCount()}
                                   <div class="p-1 ms-1  rounded-3 bg-tagPurple"> {Localisation::getTranslation('common_word_count')}: <strong>{$task->getWordCount()}</strong> </div>
                                {/if}
