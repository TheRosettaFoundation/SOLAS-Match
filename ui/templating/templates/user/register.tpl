      ...
      {if (empty($disabled))}
        <form method="post" id="registerform" action="{urlFor name="register"}" class="well" accept-charset="utf-8">
             <div class="d-flex">
              ...
              <input name="age_consent" id="age_consent" class="form-check-input mb-3"  type="checkbox"> I confirm I am over the age of 18 <i class="icon-question-sign" id="tool" data-toggle="tooltip" title="If you are under 18 years of age, you can't volunteer with us. Our child protection policy prevents it"></i>
              </label>
              <label class="checkbox required check form-check-label">
