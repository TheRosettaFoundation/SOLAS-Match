        ...
        <form action="{urlFor name='login'}" method="post" id="openid_form">
            ...
            <fieldset>
                ...
                <div id="openid_choice">
                    ...
                    {/if}
                    <div>
                        <a href="https://twb.translationcenter.org/oauth/authorize?client_id={$client_id}&redirect_uri={$redirect_uri}&response_type=code&scope=public+user.email"  class="btn btn-primary" style="background-color: #fb8f37; margin-bottom: 10px;">
