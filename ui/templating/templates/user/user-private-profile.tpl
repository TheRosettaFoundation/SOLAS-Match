...
<script type="application/dart" src="{urlFor name="home"}ui/dartCompiled/Routes/Users/UserPrivateProfile.dart"></script>
<script src="{urlFor name="home"}ui/dartCompiled/packages/browser/dart.js"></script>
<script src="{urlFor name="home"}ui/dartCompiled/packages/browser/interop.js"></script>
