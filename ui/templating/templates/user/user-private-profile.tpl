                ...
                <td colspan="2">
                    <table>
                        ...
                        {foreach from=$cerification_list key=name item=cerification}
                            <tr align="center"><td colspan="1" align="center">{if $cerification['state']}Already submitted: {/if}<a href="{urlFor name="user-uploads" options="user_id.$user_id|cert_id.$name"}" target="_blank">{$cerification['desc']}</a></td></tr>
                        {/foreach}
                    </table>
                </td>
            </tr>
