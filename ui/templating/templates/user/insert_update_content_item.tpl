              ...
              <div class="row">
                ...
                <div class="col">
                  ...
                  <select id="type" name="type">
                    {if $org_id == 0}
                    <option value="1" {if $selected_type == 1}selected="selected"{/if}>TWB Article</option>
                    <option value="2" {if $selected_type == 2}selected="selected"{/if}>Newsletter</option>
                    <option value="3" {if $selected_type == 3}selected="selected"{/if}>Event</option>
                    <option value="4" {if $selected_type == 4}selected="selected"{/if}>Resource</option>
                    {else}
<!--                    <option value="0">External content</option> -->
                    <option value="5" {if $selected_type == 5}selected="selected"{/if}>Organization</option>
                    <option value="6" {if $selected_type == 6}selected="selected"{/if}>Project</option>
                    {/if}
                  </select>
                </div>
              </div>
