   ...
   <div class="container px-4  py-4 pt-5">
     ...
     <div class="d-flex align-items-center flex-wrap ">
                   ...
                   {if $roles & ($SITE_ADMIN + $PROJECT_OFFICER + $COMMUNITY_OFFICER)}
                            <a href="{urlFor name="claimed-tasks" options="user_id.{$this_user->getId()}"}" class="btn btn-sm btn-primary me-2 mt-2 mt-md-0 text-white   border-3 border-bottom border-primaryBorder">
        ...
        <p>If you do not want to take the test, please click “Cancel”.</p>
                    ...
                    {if isset($userPersonalInfo)}
                            <div class="mb-3 fw-bold">
                                      ...
                                      {if !empty($userPersonalInfo->getFirstName())}<h3>{TemplateHelper::uiCleanseHTML($userPersonalInfo->getFirstName())}{/if} {if !empty($userPersonalInfo->getLastName())}{TemplateHelper::uiCleanseHTML($userPersonalInfo->getLastName())}{/if}</h3>
                                     {if $roles & ($SITE_ADMIN + $PROJECT_OFFICER + $COMMUNITY_OFFICER)}
