...
<div class="d-flex justify-content-between">
    ...
    <div class="d-flex flex-column mt-4 flex-grow-1 w-25 ">
       <ul>
        {foreach $adjust_points as $adjust_point}
            ...
            <li class=" px-4">{$adjust_point['admin_comment']|escape:'html':'UTF-8'}</li>
    ...
    {foreach $adjust_points as $adjust_point}
       ...
       <div class=" text-center px-4">{$adjust_point['points']}</div>
    ...
    {foreach $adjust_points as $adjust_point}
            ...
            <div class=" px-4">{$adjust_point['created']}</div>
