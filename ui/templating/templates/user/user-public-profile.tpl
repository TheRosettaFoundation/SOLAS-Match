...
<div class="d-flex justify-content-between">
    ...
    <div class="d-flex flex-column mt-4 flex-grow-1 w-1/4">
       <ul>
    ...
    <div class="d-flex flex-column flex-grow-1 mt-4 w-1/4">
    ...
    <div class="d-flex flex-column flex-grow-1 w-1/4 mt-4 text-end ">
    ...
    <div class="d-flex flex-column w-1/4 flex-grow-1 mt-5 text-end">
