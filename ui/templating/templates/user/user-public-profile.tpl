                    ...
                    {if isset($userPersonalInfo)}
                        ...
                        {if $private_access || ($roles & ($SITE_ADMIN + $PROJECT_OFFICER + $COMMUNITY_OFFICER))}
                            <div class="mb-3 d-flex align-items-center">
                                    ...
                                    {if $roles & ($SITE_ADMIN + $PROJECT_OFFICER + $COMMUNITY_OFFICER)}
                                        <a  href='{urlFor name="change-email" options="user_id.$user_id"}' class='bg-yellowish  text-primary text-uppercase p-1 text-decoration-none'>
...
alert('You have already requested to take a test in order to become a TWB Verified Translator. If you would like to take a second test, please contact translators@translatorswithoutborders.org');
        ...
        <div class="bg-body p-4 rounded-3 text-body w-100 w-md-50">
                        ...
                        {if $roles & ($SITE_ADMIN + $PROJECT_OFFICER + $COMMUNITY_OFFICER)}
                     <a href="{urlFor name="user-uploads" options="user_id.$user_id|cert_id.TWB"}" target="_blank" class="bg-yellowish text-uppercase p-1 text-primary text-decoration-none  ">  <img src="{urlFor name='home'}ui/img/upload.svg" class="me-2" /> <span>Upload a new file for this user </span></a>
                     <hr  class="bg-light-subtle"/>  
                    {/if}
