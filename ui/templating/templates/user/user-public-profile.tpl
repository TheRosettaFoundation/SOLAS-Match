...
Only work that meets our minimum quality standards (as described in <a  class="custom-link" href="https://twbplatform.org/user%202026%20Code%20of%20Conduct%20for%20Translators%20and%20Interpreters.pdf" target="_blank">TWB’s Code of Conduct</a>)
...
<p>Currently, the languages for which we can offer monetary rewards are Amharic; Bura-Pabir; Shuwa Arabic - Arabic Script; Shuwa Arabic - Latin Script; Dari; Fulah; Haitian; Hausa; Kanuri; Kibaku; Kurdish Bahdini; Kurdish Kurmanji; Kurdish Sorani; Lingala; Ganda; Wandala (formerly Mandara); Marghi Central; Mongo; Nande; Ngombe; Oromo; Pushto; Pushto, Pakistan; Rohingya Bengali; Rohingya Latin; Shi; Somali; Somali, Ethiopia; Swahili; Swahili, Congo; Tigrinya; Lamang (formerly Waha).</p>
...
<table class="table" >
    ...
    <tr valign="top">
        ...
        <td style="width: 20%"><input class="form-control form-control-sm" type='text' value="{if !empty($linguist_payment_information['linguist_t_code'])}{$linguist_payment_information['linguist_t_code']}{/if}{if !empty($linguist_payment_information['linguist_t_code_import'])}{$linguist_payment_information['linguist_t_code_import']}{/if}" name="linguist_t_code" id="linguist_t_code" /></td>
        <td style="width: 15%">
