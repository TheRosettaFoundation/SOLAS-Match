    ...
    {if isset($this_user) && ($private_access || ($roles & ($SITE_ADMIN + $PROJECT_OFFICER + $COMMUNITY_OFFICER)) || $receive_credit)}
        ...
        <p>If you do not want to take the test, please click “Cancel”.</p>
                    ...
                    {if $url['state']|strstr:"facebook"}                    
                       <a href="{$url['state']}" target="_blank"><img src="{urlFor name='home'}ui/img/urls/facebook.svg" class="me-2"/></a>
                        {elseif $url['state']|strstr:"twitter" }
                            <a href="{$url['state']}" target="_blank"> <img alt="" src="{urlFor name='home'}ui/urls/img/x.svg" class="me-2" /></a>
                        {elseif $url['state']|strstr:"linkedin" }
                            <a href="{$url['state']}" target="_blank"> <img alt="" src="{urlFor name='home'}ui/urls/img/linkedin.svg" class="me-2" /></a>                             
