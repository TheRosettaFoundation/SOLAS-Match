                    ...
                    <ul class="nav main_nav">
                        ...
                        {if !empty($ngo_orgs)}
                            <li {if isset($current_page) && $current_page == 'ngo_projects'}class="active"{/if}>
                                <a href="{urlFor name="ngo_projects" options="org_id.{$ngo_orgs[0]['organisation_id']}"}">Projects</a>
                            </li>
                        {/if}
                        ...
                        {if !empty($ngo_orgs)}
                            <li>
                                <a href="{urlFor name="metabase_ngo" options="org_id.{$ngo_orgs[0]['organisation_id']}"}">Analytics</a>
                            </li>
                        {/if}
