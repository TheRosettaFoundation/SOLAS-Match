                    ...
                    <table>
                        <tr>
                            ...
                            <td width="38%" style="text-align: center">
                                    ...
                                    <p>
                                        {mailto address={Settings::get("site.system_email_address")} encode='hex' text='Contact Us'} | <a href="{urlFor name='terms'}">Terms of Use</a> | <a href="{urlFor name='privacy'}">Privacy Policy</a> | <a href="http://forum.solas.uni.me/" target="_blank">Community Forum</a>
                                    </p>
                                    <p>                
