...
<div class="well">
    ...
    <p><a href="{urlFor name="active_users"}" target="_blank">List all volunteers who have ever claimed a task (and which task is still on the system and not archived), the corresponding task and the task creator's email address.</a></p>
    <p><a href="{urlFor name="all_users_plain"}" target="_blank">List all users currently registered on Trommons showing information about them.</a></p>
    <p><a href="{urlFor name="user_languages"}/full" target="_blank">List all languages indicated on user's profiles showing information about the user (if you replace the "full" in the URL with a language code like "es", you will just get that language).</a></p>
