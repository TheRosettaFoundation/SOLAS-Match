...
{if $roles & ($SITE_ADMIN + $PROJECT_OFFICER + $COMMUNITY_OFFICER + 128)}
  ...
  {if $roles & ($SITE_ADMIN + 128)}
        <table>
            <tr>
                <td>
                    <h2>Purchase Order Creation <small>(tasks completed before the end of day for this date will have SUN POs generated)</small></h2>
                </td>
            </tr>
            <tr>
                <td valign="top">
        ...
        <table style="width: 40%">
            <tr>
                <td colspan="2">
                    <h2>Generate Invoices (all tasks with POs)</h2>
                </td>
            </tr>
            <tr>
                <td>
