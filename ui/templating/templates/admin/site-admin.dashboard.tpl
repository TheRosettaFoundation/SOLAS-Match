    ...
    <form method="post" enctype="multipart/form-data" action="{urlFor name="site-admin-dashboard"  options="user_id.$adminUserId"}" accept-charset="utf-8">
        <table style="width: 40%">
            ...
            {if isset($flash['verifyError'])}
                <tr>
                    <td colspan="2">
                        <p class="alert alert-error">{TemplateHelper::uiCleanseHTML($flash['verifyError'])}</p>
                    </td>
                </tr>
            {/if}
            {if isset($flash['verifySuccess'])}
                <tr>
                    <td colspan="2">
                        <p class="alert alert-success">{TemplateHelper::uiCleanseHTML($flash['verifySuccess'])}</p>
                    </td>
                </tr>
            {/if}
            <tr>
    ...
    <form method="post" enctype="multipart/form-data" action="{urlFor name="site-admin-dashboard"  options="user_id.$adminUserId"}" accept-charset="utf-8">
        <table style="width: 40%">
            ...
            {if isset($flash['deleteError'])}
                <tr>
                    <td colspan="2">
                        <p class="alert alert-error">{TemplateHelper::uiCleanseHTML($flash['deleteError'])}</p>
                    </td>
                </tr>
            {/if}
            {if isset($flash['deleteSuccess'])}
                <tr>
                    <td colspan="2">
                        <p class="alert alert-success">{TemplateHelper::uiCleanseHTML($flash['deleteSuccess'])}</p>
                    </td>
                </tr>
            {/if}
            <tr>
    ...
    <form method="post" enctype="multipart/form-data" action="{urlFor name="site-admin-dashboard"  options="user_id.$adminUserId"}" accept-charset="utf-8">
        <table style="width: 40%">
            ...
            {if isset($flash['revokeTaskError'])}
                <tr>
                    <td colspan="2">
                        <p class="alert alert-error">{TemplateHelper::uiCleanseHTML($flash['revokeTaskError'])}</p>
                    </td>
                </tr>
            {/if}
            {if isset($flash['revokeTaskSuccess'])}
                <tr>
                    <td colspan="2">
                        <p class="alert alert-success">{TemplateHelper::uiCleanseHTML($flash['revokeTaskSuccess'])}</p>
                    </td>
                </tr>
            {/if}
            <tr>
