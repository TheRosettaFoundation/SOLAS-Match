...
<div class="well">
    ...
    <p><a href="{urlFor name="active_now_matecat"}" target="_blank">List all tasks currently in progress showing their MakeCat Status.</a></p>
    <p><a href="{urlFor name="complete_matecat"}" target="_blank">List all complete tasks showing their MakeCat Status.</a></p>
