...
<table id="myTable" style="overflow-wrap: break-word;" class="container table table-striped">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>{if $pr['status'] == 0}Open{/if}{if $pr['status'] == 1}1{/if}{if $pr['status'] == 2}Awaiting Approval{/if}{if $pr['status'] == 3}Awaiting Purchasing{/if}{if $pr['status'] == 4}PO Generated{/if}{if $pr['status'] == 5}Rejected{/if}</td>
            <td>${$pr['total']}</td>
