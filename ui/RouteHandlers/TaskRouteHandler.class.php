...
//        }
    ...
    public function taskAlter(Request $request, Response $response, $args)
    {
        ...
        $extra_scripts = "
        <script type=\"text/javascript\" src=\"{$app->getRouteCollector()->getRouteParser()->urlFor("home")}ui/js/jquery.min.js\" defer ></script>
        <script type=\"text/javascript\" src=\"{$app->getRouteCollector()->getRouteParser()->urlFor("home")}ui/js/popper.js\" defer></script>
        <script type=\"text/javascript\" src=\"{$app->getRouteCollector()->getRouteParser()->urlFor("home")}ui/js/bootstrap.min.js\" defer</script>
        <script type=\"text/javascript\" src=\"{$app->getRouteCollector()->getRouteParser()->urlFor("home")}ui/js/moment-with-locales.min.js\" defer ></script>
        <script type=\"text/javascript\" src=\"{$app->getRouteCollector()->getRouteParser()->urlFor("home")}ui/js/bootstrap-datetimepicker.min.js\" defer></script>
        <script type=\"text/javascript\" src=\"{$app->getRouteCollector()->getRouteParser()->urlFor("home")}ui/js/main.js\" defer></script>
        ";
