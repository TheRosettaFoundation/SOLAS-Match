...
class TaskRouteHandler
{
    ...
    public function claimedTasks(Request $request, Response $response, $args)
    {
        ...
        $extra_scripts .= "<script type=\"text/javascript\" src=\"{$app->getRouteCollector()->getRouteParser()->urlFor("home")}ui/js/Home1.js\"></script>";
            ...
            if (($roles & (SITE_ADMIN | PROJECT_OFFICER)) && isset($post['mark_payment_status'])) {
                if ($paid_status['payment_status'] == 'Unsettled'             && $post['mark_payment_status'] == 'In-kind'
                    ...
                    $paid_status['payment_status'] == 'Unsettled'             && $post['mark_payment_status'] == 'Waived'
                        ||
                    $paid_status['payment_status'] == 'Unsettled'             && $post['mark_payment_status'] == 'Company'
                        ||
                    ...
                    $paid_status['payment_status'] == 'Waived'                && $post['mark_payment_status'] == 'Unsettled')
                        ||
                    $paid_status['payment_status'] == 'Company'               && $post['mark_payment_status'] == 'Unsettled')
                {
