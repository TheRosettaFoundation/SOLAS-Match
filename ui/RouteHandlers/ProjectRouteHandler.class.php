...
//(**)dev server                    $user_id = 3297;
    ...
    public function projectView(Request $request, Response $response, $args)
    {
        ...
        if ($taskDao->isUserRestrictedFromProject($project_id, $user_id) || in_array($project_id, [36065, 36066, 36067, 36068, 36068, 36072, 36070, 36069, 36071, 36073, 36074, 36075, 36076, 36958])) { // or Moodle
