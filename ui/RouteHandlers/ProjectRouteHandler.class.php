...
if (!empty($dependent_task)) error_log("Here 4 {$dependent_task['prerequisite']}");
if ($dependent_task['prerequisite'] == $task_id) error_log("Here 5");
...
error_log("Here 7 {$dependent_task['task_id']}");
