...
class UserRouteHandler
{
    ...
    public function register($track_code = '')
    {
        ...
        if ($appendExtraScripts) {
            $extra_scripts .= '<script type="text/javascript">function compareEmails() {if (document.getElementById("email") != document.getElementById("email2")) {window.alert("Entered emails must be identical."); return false;} return true;}</script>';
