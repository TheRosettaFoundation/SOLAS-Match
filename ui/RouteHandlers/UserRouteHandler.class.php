...
$project->setOrganisationId(380);//DEV SERVER
                        ...
                        if (empty($project)) {
                            ...
                            '">This is your Verification task</a>, which you <strong>must</strong> translate using Kató TM. You will need to refresh that page after a few minutes in order to see the Kató TM URL translation link. Please, check your email inbox in a few minutes for instructions');
                        }
                    }
                }
            }
