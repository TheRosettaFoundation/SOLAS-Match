...
class UserRouteHandler
{
    ...
    public static function user_rate_pairs(Request $request, Response $response, $args)
    {
        ...
        function add_row() {
            ...
            var f_task_type  = $("<div class=\"span2\"><select name=\"task_type_"                  + row_count + "\" id=\"task_type_"                  + row_count + "\" class=\"field_select_type\"><option value>--Select a task type--</option>' . $task_type   . '</select></div>");
            ...
            var f_target     = $("<div class=\"span4\"><select name=\"language_country_id_target_" + row_count + "\" id=\"language_country_id_target_" + row_count + "\" class=\"field_select_lang\"><option value>--Select a language--</option>'  . $target_lang . '</select></div>");
