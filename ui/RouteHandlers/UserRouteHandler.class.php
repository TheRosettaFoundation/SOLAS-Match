...
class UserRouteHandler
{
    ...
    public function home(Request $request, Response $response)
    {
        ...
        $extra_scripts .= "<script type=\"text/javascript\" src=\"{$app->getRouteCollector()->getRouteParser()->urlFor("home")}ui/js/Home3.js?v=14875469ej4\"></script>";
        $extra_scripts .= "<script type=\"text/javascript\"  src=\"{$app->getRouteCollector()->getRouteParser()->urlFor("home")}ui/js/pagination.js?v=1447eke6df\" defer ></script>";
