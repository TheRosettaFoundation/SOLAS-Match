...
$html = <<<EOF
        ...
        <tr valign="bottom">
              ...
              <td class="header1" rowspan="2" align="left" valign="middle"
                    width="25%">
                    <div style="font-weight:bold; float:left ; font-size:48px;">INVOICE</div>
...
<thead>
 <tr style="background-color:#FAFAFA;color:black;">
  ...
  <td width="300"  style="margin-left:10px;"><b>Description</b></td>
 ...
 <tr>
  ...
  <td width="300"  style="margin-right:10px;"> $description<br /> <span style="font-weight:bold;"> $project </span> <br /> $language<br />  $type<br /></td>
