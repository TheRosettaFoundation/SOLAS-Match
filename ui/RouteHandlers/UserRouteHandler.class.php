...
class UserRouteHandler
{
    ...
    public function home(Request $request, Response $response, $args)
    {
        ...
        $extra_scripts .= "<script type=\"text/javascript\" src=\"{$app->getRouteCollector()->getRouteParser()->urlFor("home")}ui/js/pagination.js\"></script>";
    ...
    public function homeDemo(Request $request, Response $response, $args)
    {
        global $app, $template_data;
        $currentScrollPage          = !empty($args['page_no']) ? $args['page_no'] : 1;
        $selectedTaskType           = !empty($args['tt'])      ? $args['tt'] : 0;
