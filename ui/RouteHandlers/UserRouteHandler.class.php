...
class UserRouteHandler
{
    ...
    public static function user_rate_pairs(Request $request, Response $response, $args)
    {
        ...
        $(document).ready(function() {
            ...
            for ( ; row_count < user_rate_pairs_count; row_count++) {
                ...
                if (getSetting("user_rate_pair_language_id_source_" + row_count) != "") {
                    ...
                    document.getElementById("#unit_rate" + row_count).value = getSetting("user_rate_pair_unit_rate_" + row_count);
                }
            }
        });
        ...
        function add_row() {
            ...
            var f_task_type  = $("<div class=\"span4\"><select name=\"task_type_"                  + row_count + "\" id=\"task_type_"                  + row_count + "\" class=\"field_select_type\"><option value>--Select a task type--</option>' . $task_type   . '</select></div>");
            var f_source     = $("<div class=\"span5\"><select name=\"language_id_source_"         + row_count + "\" id=\"language_id_source_"         + row_count + "\" class=\"field_select_lang\"><option value>--Select a language--</option>'  . $source_lang . '</select></div>");
            var f_target     = $("<div class=\"span5\"><select name=\"language_country_id_target_" + row_count + "\" id=\"language_country_id_target_" + row_count + "\" class=\"field_select_lang\"><option value>--Select a language--</option>'  . $target_lang . '</select></div>");
            var f_unit_rate  = $("<div class=\"span2\"><input  name=\"unit_rate_"                  + row_count + "\" id=\"unit_rate_"                  + row_count + "\" class=\"field_unit_rate\" type=\"text\" value="" />                                                   </div>");
