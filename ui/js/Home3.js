        ...
        $(this).html(
            parameters.getTranslation("common_due_by").replace(
                ...
                "<div class='px-1'>" +
                    ...
                    d +
                    "</div>" +
                    `<div class="mx-3 d-flex align-items-center bg-secondary text-white">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#f89406" class="bi bi-clock" viewBox="0 0 24 24">
