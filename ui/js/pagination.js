...
function displayTasks(pages) {
    ...
    for (const item of parsed.tasks) {
        ...
        <strong class="d-flex align-items-center"> <div class="mx-2 ">  ${deadline.getFullYear()}- ${m} - ${d} -"test"+  </div>  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#f89406" class="bi bi-clock" viewBox="0 0 16 16" class="mx-1">
