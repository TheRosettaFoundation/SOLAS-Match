...
function loadingComplete()
{
  if (getSetting("split") == 1) {
    document.getElementById("source_text_desc").innerHTML =
      "Upload your source file for the project. Do not upload PDF files, ZIP files, or image files with text like JPG, PNG or GIF. If the total word count of the file exceeds 900 words, it will be split into multiple tasks for translation. "
