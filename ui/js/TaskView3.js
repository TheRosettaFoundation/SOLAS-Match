...
//      document.getElementById("head_show-revision-btn").innerHTML = '<a href="https://twbplatform.org" class="tooltip" style="pointer-events: none; color: gray; cursor: default;" aria-disabled="true">Work on the task<span class="tooltiptext">You must wait for the completion of the previous step before starting on this task.</span></a>';
//      document.getElementById("head_show-revision-btn").innerHTML = '<a href="https://twbplatform.org" class="tooltip" aria-disabled="true">Work on the task<span class="tooltiptext">You must wait for the completion of the previous step before starting on this task.</span></a>';
      document.getElementById("head_show-revision-btn").innerHTML = '<div href="https://twbplatform.org" class="tooltip" aria-disabled="true">Work on the task<span class="tooltiptext">You must wait for the completion of the previous step before starting on this task.</span></div>';
    } else {
