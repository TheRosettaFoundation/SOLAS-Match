...
class ProjectCreateForm extends PolymerElement with ChangeNotifier 
{
  // Bound Attributes
  ...
  @reflectable @published int get orgid => __$orgid; int __$orgid; @reflectable set orgid(int value) { __$orgid = notifyPropertyChange(#orgid, __$orgid, value); }
  @reflectable @published int get maxfilesize => __$maxfilesize; int __$maxfilesize; @reflectable set maxfilesize(int value) { __$maxfilesize = notifyPropertyChange(#maxfilesize, __$maxfilesize, value); }
  ...
  @reflectable @observable List<int> get years => __$years; List<int> __$years; @reflectable set years(List<int> value) { __$years = notifyPropertyChange(#years, __$years, value); }
  @reflectable @observable List<String> get months => __$months; List<String> __$months; @reflectable set months(List<String> value) { __$months = notifyPropertyChange(#months, __$months, value); }
  @reflectable @observable List<int> get days => __$days; List<int> __$days; @reflectable set days(List<int> value) { __$days = notifyPropertyChange(#days, __$days, value); }
  @reflectable @observable List<int> get hours => __$hours; List<int> __$hours; @reflectable set hours(List<int> value) { __$hours = notifyPropertyChange(#hours, __$hours, value); }
  @reflectable @observable List<int> get minutes => __$minutes; List<int> __$minutes; @reflectable set minutes(List<int> value) { __$minutes = notifyPropertyChange(#minutes, __$minutes, value); }
  @reflectable @observable int get selectedYear => __$selectedYear; int __$selectedYear = 0; @reflectable set selectedYear(int value) { __$selectedYear = notifyPropertyChange(#selectedYear, __$selectedYear, value); }
  @reflectable @observable int get selectedMonth => __$selectedMonth; int __$selectedMonth = 0; @reflectable set selectedMonth(int value) { __$selectedMonth = notifyPropertyChange(#selectedMonth, __$selectedMonth, value); }
  @reflectable @observable int get selectedDay => __$selectedDay; int __$selectedDay = 0; @reflectable set selectedDay(int value) { __$selectedDay = notifyPropertyChange(#selectedDay, __$selectedDay, value); }
  @reflectable @observable int get selectedHour => __$selectedHour; int __$selectedHour = 0; @reflectable set selectedHour(int value) { __$selectedHour = notifyPropertyChange(#selectedHour, __$selectedHour, value); }
  @reflectable @observable int get selectedMinute => __$selectedMinute; int __$selectedMinute = 0; @reflectable set selectedMinute(int value) { __$selectedMinute = notifyPropertyChange(#selectedMinute, __$selectedMinute, value); }
  @reflectable @observable String get orgDashboardLink => __$orgDashboardLink; String __$orgDashboardLink; @reflectable set orgDashboardLink(String value) { __$orgDashboardLink = notifyPropertyChange(#orgDashboardLink, __$orgDashboardLink, value); }
  @reflectable @observable bool get publish => __$publish; bool __$publish; @reflectable set publish(bool value) { __$publish = notifyPropertyChange(#publish, __$publish, value); }
  @reflectable @observable bool get trackProject => __$trackProject; bool __$trackProject; @reflectable set trackProject(bool value) { __$trackProject = notifyPropertyChange(#trackProject, __$trackProject, value); }
  @reflectable @observable bool get loaded => __$loaded; bool __$loaded; @reflectable set loaded(bool value) { __$loaded = notifyPropertyChange(#loaded, __$loaded, value); }
  ...
  @reflectable @observable int get targetCount => __$targetCount; int __$targetCount; @reflectable set targetCount(int value) { __$targetCount = notifyPropertyChange(#targetCount, __$targetCount, value); }
  @reflectable @observable String get maxTargetsReached => __$maxTargetsReached; String __$maxTargetsReached; @reflectable set maxTargetsReached(String value) { __$maxTargetsReached = notifyPropertyChange(#maxTargetsReached, __$maxTargetsReached, value); }
  ...
  // Error Variables
  @reflectable @observable String get titleError => __$titleError; String __$titleError; @reflectable set titleError(String value) { __$titleError = notifyPropertyChange(#titleError, __$titleError, value); }
  @reflectable @observable String get descriptionError => __$descriptionError; String __$descriptionError; @reflectable set descriptionError(String value) { __$descriptionError = notifyPropertyChange(#descriptionError, __$descriptionError, value); }
  @reflectable @observable String get wordCountError => __$wordCountError; String __$wordCountError; @reflectable set wordCountError(String value) { __$wordCountError = notifyPropertyChange(#wordCountError, __$wordCountError, value); }
