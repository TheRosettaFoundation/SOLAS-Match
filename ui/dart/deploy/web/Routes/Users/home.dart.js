...
APIHelper: {"": "Object;format",
  call$5: function(objectType, url, method, data, queryArgs) {
    ...
    if (t2 != null) {
      ...
      headers.$indexSet(headers, "X-Custom-Authorization", $._CryptoUtils_bytesToHex(t2.close$0(t2)));
    }
  ...
  $isFunction: true,
  static: {
"": "APIHelper_UserObject,APIHelper_SolasMatch",
APIHelper_init: function() {
  return $.HttpRequest_request($.$add$ns($.get$Settings__instance()._conf.get$urls().get$SiteLocation(), "static/getUser/"), "GET", null, null, null, null, null, true).then$1(new $.APIHelper_init_closure());
},
...
ModelFactory_generateUserFromMap: function(userData) {
  ...
  if (userData.containsKey$1("nativeLocale") === true)
    ...
    user.nativeLocale = new $.Locale(null, null, null, null);
  return user;
},
...
_AllMatchesIterable: {"": "IterableBase;_re,_liblib7$_string",
  get$iterator: function(_) {
    return new $._AllMatchesIterator(this._re, this._liblib7$_string, null);
  },
  "+iterator": 0,
  $asIterable: function() {
    return [$.Match];
...
MD5: {"": "_HashBase;_chunkSizeInWords,_digestSizeInWords,_bigEndianWords,_lengthInBytes,_pendingData,_currentChunk,_h,_digestCalled",
  _updateHash$1: function(m) {
    var t1, t2, a, b, c, d, i, t00, t10, mod_shift, b0, t3;
    t1 = this._h;
    t2 = t1.length;
    if (0 >= t2)
      throw $.ioore(0);
    a = t1[0];
    if (typeof a !== "number")
      return this._updateHash$1$bailout1(1, m, t1, a, t2);
    if (1 >= t2)
      throw $.ioore(1);
    b = t1[1];
    if (typeof b !== "number")
      return this._updateHash$1$bailout1(2, m, t1, a, t2, b);
    if (2 >= t2)
      throw $.ioore(2);
    c = t1[2];
    if (typeof c !== "number")
      return this._updateHash$1$bailout1(3, m, t1, a, t2, b, c);
    if (3 >= t2)
      throw $.ioore(3);
    d = t1[3];
    if (typeof d !== "number")
      return this._updateHash$1$bailout1(4, m, 0, a, 0, b, c, d);
    for (t1 = m.length, i = 0; i < 64; ++i, a = d, d = c, c = b, b = b0) {
      ...
      if (typeof t10 !== "number")
        throw $.iae(t10);
      t10 = (((a + t00 & 4294967295) >>> 0) + ((t2 + t10 & 4294967295) >>> 0) & 4294967295) >>> 0;
      mod_shift = $.List_kcl[i] & 31;
      t10 = b + (($.JSInt_methods.$shl(t10, mod_shift) & 4294967295 | $.JSInt_methods.$shr((t10 & 4294967295) >>> 0, 32 - mod_shift)) >>> 0);
      if (t10 !== (t10 | 0))
        return this._updateHash$1$bailout1(5, m, t1, 0, 0, b, c, d, t10, i);
      b0 = (t10 & 4294967295) >>> 0;
    }
    t1 = this._h;
    t2 = t1.length;
  ...
  "+_updateHash:1:0": 0,
  _updateHash$1$bailout1: function(state0, m, t1, a, t2, b, c, d, t10, i) {
    switch (state0) {
      case 0:
        t1 = this._h;
        t2 = t1.length;
          ...
          while (true)
            switch (state0) {
              case 0:
                ...
                if (typeof t10 !== "number")
                  throw $.iae(t10);
                t10 = $.$and$in($.$add$ns(t2, (t3 + t10 & 4294967295) >>> 0), 4294967295);
                mod_shift = $.List_kcl[i] & 31;
                t3 = $.getInterceptor$in(t10);
                t10 = $.$add$ns(b, $.$or$n($.$and$in(t3.$shl(t10, mod_shift), 4294967295), $.$shr$n(t3.$and(t10, 4294967295), 32 - mod_shift)));
              case 5:
                state0 = 0;
                b0 = $.$and$in(t10, 4294967295);
                ++i;
                a = d;
                d = c;
                c = b;
...
ListQueue: {"": "IterableBase;_table,_liblib1$_head,_liblib1$_tail,_modificationCount",
  ...
  elementAt$1: function(_, index) {
    ...
    t1 = this._table;
    t2 = $.$and$in($.$add$ns(this._liblib1$_head, index), this._table.length - 1);
...
ObservableList: {"": "ListMixinWorkaround_Observable;_liblib2$_list,$$_observers,$$_changes,hashCode",
  ...
  sublist$2: function(_, start, end) {
    ...
    t2 = $.ObservableList$(null, $.getRuntimeTypeArgument(this, "ObservableList", 0));
    t2.addAll$1(t2, t1);
    return t2;
  },
  "+sublist:1:1": 0,
...
_ObservableSetIterator: {"": "Object;_set,_liblib12$_iterator,_liblib12$_hasNext",
  moveNext$0: function() {
    var t1, t2;
    t1 = this._set;
    t2 = $._activeObserver;
...
// Native classes
$.defineNativeMethods("DOMParser|Navigator|SVGAnimatedEnumeration|SVGAnimatedNumberList", $.Interceptor);
...
function init() {
  ...
  Isolate.$finishClasses = function(collectedClasses, isolateProperties, existingIsolateProperties) {
    ...
    var objectClassObject = collectedClasses.Object, shortNames = "call$0,call$1,call$2,call$3,call$4,eval$1,then$1,get$_id,write$1,_splay$1,cancel$0,create$0,get$_key,get$keys,get$left,get$next,get$node,get$sink,get$urls,listen$1,listen$2,lookup$1,set$left,set$next,toJson$0,_remove$1,addTask$1,created$0,get$_list,get$_name,get$_zone,get$isUrl,get$right,get$tasks,perform$1,process$0,removed$0,set$_head,set$_next,set$_tail,set$right,_deliver$0,_iterate$0,_onError$1,addTasks$0,get$_state,get$_value,get$orgMap,get$userId,inserted$0,moveNext$0,runAsync$2,set$_state,set$_value,set$userId,visitMap$1,writeAll$2,_addError$1,_callback$2,_dispatch$1,bodySetup$1,get$current,iterSetup$3,set$_handle,visitList$1,_sendError$1,_sendValue$1,catchError$1,get$colour_1,get$colour_2,get$colour_3,get$colour_4,get$deadline,get$isGetter,get$isSetter,get$taskAges,get$taskTags,get$taskType,handleNext$1,oneWayBind$4,_addNewRoot$2,conditional$3,containsKey$1,contentBind$2,get$_callback,get$_contents,get$_duration,get$_workerId,get$isVisible,get$moreTasks,get$projectId,get$taskTypes,get$wordCount,set$_previous,set$isVisible,_addListener$1,_runCallback$1,_subscribeTo$1,_wordToBytes$1,filterStream$0,get$$$_changes,get$SOLASMatch,get$_errorZone,get$_isChained,get$_isolateId,get$_scheduled,get$isAccessor,get$memberName,get$projectMap,runIteration$0,set$$$_changes,set$_scheduled,_bytesToChunk$2,_checkReplyTo$1,_finalizeData$0,_liblib9$_add$1,get$countryName,get$createdTime,get$siteAddress,visitSendPort$1,_resultAsBytes$0,get$$$_observers,get$SiteLocation,get$_chainSource,get$_liblib5$_id,get$_receivePort,get$languageName,get$sourceLocale,get$targetLocale,get$task_colours,set$$$_observers,visitPrimitive$1,_removeInternal$0,_zonedSendError$1,_zonedSendValue$1,composeChildren$0,get$_nextListener,get$taskOneColour,get$taskTwoColour,loopIterateAttr$3,processTaskList$1,set$_nextListener,set$taskOneColour,set$taskTwoColour,visitCloseToken$1,_distributeNodes$2,_extractElements$1,_inSameErrorZone$1,_liblib9$_onData$1,_rebuildWorkList$1,compareAndNotify$0,get$_liblib1$_next,get$inMilliseconds,get$isolateStatics,get$namedArguments,get$organisationId,get$taskFourColour,set$_liblib1$_next,set$taskFourColour,visitIsolateSink$1,_createShadowRoot$0,get$activeLanguages,get$taskThreeColour,get$taskTypeIndexes,set$taskThreeColour,_setErrorUnchecked$1,_setValueUnchecked$1,get$_liblib0$_length,set$_liblib0$_length,deserializeSendPort$1,handleUncaughtError$1,loadActiveLanguages$0,get$_liblib1$_previous,get$_resultOrListeners,set$_liblib1$_previous,created_autogenerated$0,deserializeCloseToken$1,get$positionalArguments,removed_autogenerated$0,deserializeIsolateSink$1,get$selectedSourceFilter,get$selectedTargetFilter,inserted_autogenerated$0,set$selectedSourceFilter,set$selectedTargetFilter,_findLeftMostDescendent$1,get$millisecondsSinceEpoch,get$selectedTaskTypeFilter,set$selectedTaskTypeFilter".split(","), longNames = "call,call,call,call,call,eval,then,_id,write,_splay,cancel,create,_key,keys,left,next,node,sink,urls,listen,listen,lookup,left=,next=,toJson,_remove,addTask,created,_list,_name,_zone,isUrl,right,tasks,perform,process,removed,_head=,_next=,_tail=,right=,_deliver,_iterate,_onError,addTasks,_state,_value,orgMap,userId,inserted,moveNext,runAsync,_state=,_value=,userId=,visitMap,writeAll,_addError,_callback,_dispatch,bodySetup,current,iterSetup,_handle=,visitList,_sendError,_sendValue,catchError,colour_1,colour_2,colour_3,colour_4,deadline,isGetter,isSetter,taskAges,taskTags,taskType,handleNext,oneWayBind,_addNewRoot,conditional,containsKey,contentBind,_callback,_contents,_duration,_workerId,isVisible,moreTasks,projectId,taskTypes,wordCount,_previous=,isVisible=,_addListener,_runCallback,_subscribeTo,_wordToBytes,filterStream,$_changes,SOLASMatch,_errorZone,_isChained,_isolateId,_scheduled,isAccessor,memberName,projectMap,runIteration,$_changes=,_scheduled=,_bytesToChunk,_checkReplyTo,_finalizeData,_add,countryName,createdTime,siteAddress,visitSendPort,_resultAsBytes,$_observers,SiteLocation,_chainSource,_id,_receivePort,languageName,sourceLocale,targetLocale,task_colours,$_observers=,visitPrimitive,_removeInternal,_zonedSendError,_zonedSendValue,composeChildren,_nextListener,taskOneColour,taskTwoColour,loopIterateAttr,processTaskList,_nextListener=,taskOneColour=,taskTwoColour=,visitCloseToken,_distributeNodes,_extractElements,_inSameErrorZone,_onData,_rebuildWorkList,compareAndNotify,_next,inMilliseconds,isolateStatics,namedArguments,organisationId,taskFourColour,_next=,taskFourColour=,visitIsolateSink,_createShadowRoot,activeLanguages,taskThreeColour,taskTypeIndexes,taskThreeColour=,_setErrorUnchecked,_setValueUnchecked,_length,_length=,deserializeSendPort,handleUncaughtError,loadActiveLanguages,_previous,_resultOrListeners,_previous=,created_autogenerated,deserializeCloseToken,positionalArguments,removed_autogenerated,deserializeIsolateSink,selectedSourceFilter,selectedTargetFilter,inserted_autogenerated,selectedSourceFilter=,selectedTargetFilter=,_findLeftMostDescendent,millisecondsSinceEpoch,selectedTaskTypeFilter,selectedTaskTypeFilter=".split(",");
