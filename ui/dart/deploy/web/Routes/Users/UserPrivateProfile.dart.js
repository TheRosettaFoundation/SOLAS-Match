                                      ...
                                      if (state0 === 1 || state0 === 0 && typeof object === "object" && object !== null && (object.constructor === Array || !!$.getInterceptor(object).$isList))
                                        switch (state0) {
                                          ...
                                          case 1:
                                            ...
                                            if ($.$gt$in(t2.get$length(object), 0) === true) {
  ...
  while (true) {
    ...
    if (t2.$lt(charCode, 32) === true) {
      ...
      switch (charCode) {
        ...
        default:
          charCodes.push(117);
          t3 = $.$and$in(t2.$shr(charCode, 12), 15);
          if ($.$lt$in(t3, 10) === true) {
            if (typeof t3 !== "number")
              throw $.iae(t3);
            t3 = 48 + t3;
          ...
          charCodes.push(t3);
          t3 = $.$and$in(t2.$shr(charCode, 8), 15);
          if ($.$lt$in(t3, 10) === true) {
            if (typeof t3 !== "number")
              throw $.iae(t3);
            t3 = 48 + t3;
          ...
          charCodes.push(t3);
          t3 = $.$and$in(t2.$shr(charCode, 4), 15);
          if ($.$lt$in(t3, 10) === true) {
            if (typeof t3 !== "number")
              throw $.iae(t3);
            t3 = 48 + t3;
...
function init() {
  ...
  Isolate.$finishClasses = function(collectedClasses, isolateProperties, existingIsolateProperties) {
    ...
    var objectClassObject = collectedClasses.Object, shortNames = "call$0,call$1,call$2,call$3,call$4,eval$1,then$1,get$_id,get$sip,set$sip,write$1,_splay$1,cancel$0,create$0,get$_key,get$city,get$keys,get$next,get$sink,get$urls,get$user,listen$1,listen$2,lookup$1,modify$1,set$city,set$next,set$user,toJson$0,_remove$1,created$0,get$_list,get$_name,get$_zone,get$isUrl,perform$1,process$0,removed$0,set$_head,set$_next,set$_tail,_deliver$0,_iterate$0,_onError$1,get$_state,get$_value,get$badges,get$userId,moveNext$0,runAsync$2,set$_state,set$_value,set$badges,set$userId,visitMap$1,writeAll$2,_addError$1,_callback$2,_dispatch$1,bodySetup$1,get$address,get$country,get$current,set$_handle,set$address,set$country,visitList$1,_sendError$1,_sendValue$1,catchError$1,deleteUser$0,get$isGetter,get$isLoaded,get$isSetter,get$jobTitle,get$lastName,get$userInfo,handleNext$1,oneWayBind$4,set$jobTitle,set$lastName,set$userInfo,_addNewRoot$2,conditional$3,containsKey$1,contentBind$2,get$_callback,get$_contents,get$_duration,get$_workerId,get$biography,get$countries,get$firstName,get$isVisible,get$languages,readClasses$0,set$_previous,set$biography,set$firstName,set$isVisible,_addListener$1,_runCallback$1,_subscribeTo$1,_wordToBytes$1,get$$$_changes,get$SOLASMatch,get$_errorZone,get$_isChained,get$_isolateId,get$_scheduled,get$isAccessor,get$memberName,get$translator,runIteration$0,set$$$_changes,set$_scheduled,set$translator,_bytesToChunk$2,_checkReplyTo$1,_finalizeData$0,_liblib9$_add$1,get$countryCode,get$interpreter,get$proofreader,set$countryCode,set$interpreter,set$proofreader,visitSendPort$1,_resultAsBytes$0,get$$$_observers,get$SiteLocation,get$_chainSource,get$_liblib5$_id,get$_receivePort,get$display_name,get$languageCode,get$mobileNumber,get$nativeLocale,set$$$_observers,set$display_name,set$languageCode,set$mobileNumber,visitPrimitive$1,_zonedSendError$1,_zonedSendValue$1,composeChildren$0,get$_nextListener,set$_nextListener,visitCloseToken$1,_distributeNodes$2,_extractElements$1,_inSameErrorZone$1,_liblib9$_onData$1,_rebuildWorkList$1,compareAndNotify$0,get$_liblib1$_next,get$businessNumber,get$isolateStatics,get$namedArguments,set$_liblib1$_next,set$businessNumber,visitIsolateSink$1,_createShadowRoot$0,_setErrorUnchecked$1,_setValueUnchecked$1,get$_liblib0$_length,set$_liblib0$_length,deserializeSendPort$1,get$_liblib1$_element,handleUncaughtError$1,addSecondaryLanguage$0,get$_liblib1$_previous,get$_resultOrListeners,set$_liblib1$_previous,deserializeCloseToken$1,get$positionalArguments,deserializeIsolateSink$1,_findLeftMostDescendent$1,removeSecondaryLanguage$0,get$userSecondaryLanguages".split(","), longNames = "call,call,call,call,call,eval,then,_id,sip,sip=,write,_splay,cancel,create,_key,city,keys,next,sink,urls,user,listen,listen,lookup,modify,city=,next=,user=,toJson,_remove,created,_list,_name,_zone,isUrl,perform,process,removed,_head=,_next=,_tail=,_deliver,_iterate,_onError,_state,_value,badges,userId,moveNext,runAsync,_state=,_value=,badges=,userId=,visitMap,writeAll,_addError,_callback,_dispatch,bodySetup,address,country,current,_handle=,address=,country=,visitList,_sendError,_sendValue,catchError,deleteUser,isGetter,isLoaded,isSetter,jobTitle,lastName,userInfo,handleNext,oneWayBind,jobTitle=,lastName=,userInfo=,_addNewRoot,conditional,containsKey,contentBind,_callback,_contents,_duration,_workerId,biography,countries,firstName,isVisible,languages,readClasses,_previous=,biography=,firstName=,isVisible=,_addListener,_runCallback,_subscribeTo,_wordToBytes,$_changes,SOLASMatch,_errorZone,_isChained,_isolateId,_scheduled,isAccessor,memberName,translator,runIteration,$_changes=,_scheduled=,translator=,_bytesToChunk,_checkReplyTo,_finalizeData,_add,countryCode,interpreter,proofreader,countryCode=,interpreter=,proofreader=,visitSendPort,_resultAsBytes,$_observers,SiteLocation,_chainSource,_id,_receivePort,display_name,languageCode,mobileNumber,nativeLocale,$_observers=,display_name=,languageCode=,mobileNumber=,visitPrimitive,_zonedSendError,_zonedSendValue,composeChildren,_nextListener,_nextListener=,visitCloseToken,_distributeNodes,_extractElements,_inSameErrorZone,_onData,_rebuildWorkList,compareAndNotify,_next,businessNumber,isolateStatics,namedArguments,_next=,businessNumber=,visitIsolateSink,_createShadowRoot,_setErrorUnchecked,_setValueUnchecked,_length,_length=,deserializeSendPort,_element,handleUncaughtError,addSecondaryLanguage,_previous,_resultOrListeners,_previous=,deserializeCloseToken,positionalArguments,deserializeIsolateSink,_findLeftMostDescendent,removeSecondaryLanguage,userSecondaryLanguages".split(",");
