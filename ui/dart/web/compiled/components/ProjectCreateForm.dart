...
class ProjectCreateForm extends WebComponent with Observable 
{
  ...
  void created_autogenerated() {
    ...
    var __binding55 = __t.contentBind(() => maxFileSize, false);
  ...
  int get maxFileSize {
    if (__observe.observeReads) {
      __observe.notifyRead(this, __observe.ChangeRecord.FIELD, 'maxFileSize');
    }
    return __$maxFileSize;
  }
  set maxFileSize(int value) {
    if (__observe.hasObservers(this)) {
      __observe.notifyChange(this, __observe.ChangeRecord.FIELD, 'maxFileSize',
          __$maxFileSize, value);
    }
    __$maxFileSize = value;
  }
  int __$targetCount;
