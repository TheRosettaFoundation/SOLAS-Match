...
class TaskStream extends WebComponent with Observable 
{
  ...
  void created_autogenerated() {
    ...
    __e75 = __root.nodes[3];
    __t.conditional(__e75, () => tasks.length > 0, (__t) {
      var __e71, __e74;
      __e71 = __html13.clone(true);
      __t.loop(__e71, () => tasks, ($list, $index, __t) {
        var task = $list[$index];
        var __e25, __e29, __e32, __e35, __e38, __e39, __e43, __e47, __e50, __e51, __e54, __e56, __e59, __e60, __e69, __e70;
        __e70 = __html14.clone(true);
        __e25 = __e70.nodes[1].nodes[1];
        var __binding24 = __t.contentBind(() => task.title, false);
        __e25.nodes.addAll([new autogenerated.Text('\n                  '),
            __binding24,
            new autogenerated.Text('\n                ')]);
        __t.bind(() => task.id,  (__e) { __e25.href = autogenerated.sanitizeUri('http://127.0.0.1/Solas-Match/task/${__e.newValue}/id'); }, false);
        __e39 = __e70.nodes[3];
        ...
        __e47.nodes.addAll([new autogenerated.Text('\n                '),
            ...
            new autogenerated.Text('\n              ')]);
        __e51 = __e70.nodes[9];
        var __binding48 = __t.contentBind(() => Localisation.getTranslation("common_word_count"), false);
        __e50 = __html23.clone(true);
        var __binding49 = __t.contentBind(() => task.wordCount, false);
        __e50.nodes.add(__binding49);
        __e51.nodes.addAll([new autogenerated.Text('\n                '),
            __binding48,
            new autogenerated.Text(': '),
            __e50,
            new autogenerated.Text('\n              ')]);
        __e56 = __e70.nodes[11];
        var __binding52 = __t.contentBind(() => Localisation.getTranslation("common_added"), false);
        __e54 = __html24.clone(true);
        var __binding53 = __t.contentBind(() => task.createdTime, false);
        __e54.nodes.add(__binding53);
        var __binding55 = __t.contentBind(() => Localisation.getTranslation("common_ago"), false);
        __e56.nodes.addAll([new autogenerated.Text('\n                '),
            ...
            __binding55,
            new autogenerated.Text('\n              ')]);
        __e60 = __e70.nodes[13];
        var __binding57 = __t.contentBind(() => Localisation.getTranslation("common_due_by"), false);
        __e59 = __html25.clone(true);
        var __binding58 = __t.contentBind(() => task.deadline, false);
        ...
        __e60.nodes.addAll([new autogenerated.Text('\n                '),
            ...
            __e59,
            new autogenerated.Text('\n              ')]);
        __e69 = __e70.nodes[15];
        __t.conditional(__e69, () => projectMap[task.projectId] != null, (__t) {
          var __e68;
          __e68 = __html26.clone(true);
          __t.conditional(__e68, () => orgMap[projectMap[task.projectId].organisationId] != null, (__t) {
            var __e63, __e66, __e67;
            __e67 = __html27.clone(true);
            var __binding61 = __t.contentBind(() => Localisation.getTranslation("common_part_of"), false);
            __e63 = __html28.clone(true);
            var __binding62 = __t.contentBind(() => projectMap[task.projectId].title, false);
            __e63.nodes.addAll([new autogenerated.Text('\n                      '),
                __binding62,
                new autogenerated.Text('\n                    ')]);
            __t.bind(() => projectMap[task.projectId].id,  (__e) { __e63.href = autogenerated.sanitizeUri('http://127.0.0.1/Solas-Match/project/${__e.newValue}/view'); }, false);
            var __binding64 = __t.contentBind(() => Localisation.getTranslation("common_for"), false);
            __e66 = __html29.clone(true);
            var __binding65 = __t.contentBind(() => orgMap[projectMap[task.projectId].organisationId].name, false);
            __e66.nodes.addAll([new autogenerated.Text('\n                      '),
                __binding65,
                new autogenerated.Text('\n                    ')]);
            __t.bind(() => orgMap[projectMap[task.projectId].organisationId].id,  (__e) { __e66.href = autogenerated.sanitizeUri('http://127.0.0.1/Solas-Match/org/${__e.newValue}/profile'); }, false);
      ...
      __e74 = __html30.clone(true);
      __t.conditional(__e74, () => moreTasks, (__t) {
        var __e73;
        __e73 = __html31.clone(true);
        var __binding72 = __t.contentBind(() => Localisation.getTranslation("index_load_more"), false);
        __e73.nodes.add(__binding72);
        __t.listen(__e73.onClick, ($event) { addTasks(); });
      __t.addAll([new autogenerated.Text('\n            '),
          __e73,
          new autogenerated.Text('\n          ')]);
      });
    ...
    __e78 = __root.nodes[5];
    __t.conditional(__e78, () => !(tasks.length > 0), (__t) {
      var __e77;
      __e77 = __html32.clone(true);
      var __binding76 = __t.contentBind(() => Localisation.getTranslation("index_no_tasks_available"), false);
