...
class TaskStream extends WebComponent with Observable 
{
  ...
  void created_autogenerated() {
    ...
    __e80 = __root.nodes[3];
    __t.conditional(__e80, () => tasks.length > 0, (__t) {
      var __e76, __e79;
      __e76 = __html13.clone(true);
      __t.loop(__e76, () => tasks, ($list, $index, __t) {
        var task = $list[$index];
        var __e25, __e29, __e32, __e35, __e38, __e39, __e43, __e47, __e52, __e55, __e56, __e59, __e61, __e64, __e65, __e74, __e75;
        __e75 = __html14.clone(true);
        __e25 = __e75.nodes[1].nodes[1];
        var __binding24 = __t.contentBind(() => task.title, false);
        __e25.nodes.addAll([new autogenerated.Text('\n                  '),
            __binding24,
            new autogenerated.Text('\n                ')]);
        __t.bind(() => [siteAddress, task.id],  (__e) { __e25.href = autogenerated.sanitizeUri('${__e.newValue[0]}task/${__e.newValue[1]}/id'); }, false);
        __e39 = __e75.nodes[3];
        ...
        __e43.nodes.addAll([new autogenerated.Text('\n                '),
            ...
            new autogenerated.Text('\n              ')]);
        __e47 = __e75.nodes[7];
        var __binding44 = __t.contentBind(() => Localisation.getTranslation("common_to"), false);
        var __binding45 = __t.contentBind(() => task.targetLocale.languageName, false);
        var __binding46 = __t.contentBind(() => task.targetLocale.countryName, false);
        __e47.nodes.addAll([new autogenerated.Text('\n                '),
            ...
            __binding46,
            new autogenerated.Text('\n              ')]);
        __e52 = __e75.nodes[9].nodes[1];
        __t.conditional(__e52, () => taskTags[task.id].length > 0, (__t) {
          var __e51;
          __e51 = __html23.clone(true);
          __t.loop(__e51, () => taskTags[task.id], ($list, $index, __t) {
            var tag = $list[$index];
            var __e49, __e50;
            __e50 = __html24.clone(true);
            __e49 = __e50.nodes[0];
            var __binding48 = __t.contentBind(() => tag.label, false);
            __e49.nodes.add(__binding48);
            __t.bind(() => [siteAddress, tag.id],  (__e) { __e50.href = autogenerated.sanitizeUri('${__e.newValue[0]}tag/${__e.newValue[1]}'); }, false);
          __t.addAll([new autogenerated.Text('\n                    '),
              __e50,
              new autogenerated.Text('\n                  ')]);
          });
        ...
        __e56 = __e75.nodes[11];
        var __binding53 = __t.contentBind(() => Localisation.getTranslation("common_word_count"), false);
        __e55 = __html25.clone(true);
        var __binding54 = __t.contentBind(() => task.wordCount, false);
        __e55.nodes.add(__binding54);
        __e56.nodes.addAll([new autogenerated.Text('\n                '),
            __binding53,
            new autogenerated.Text(': '),
            __e55,
            new autogenerated.Text('\n              ')]);
        __e61 = __e75.nodes[13];
        var __binding57 = __t.contentBind(() => Localisation.getTranslation("common_added"), false);
        __e59 = __html26.clone(true);
        var __binding58 = __t.contentBind(() => taskAges[task.id], false);
        __e59.nodes.add(__binding58);
        var __binding60 = __t.contentBind(() => Localisation.getTranslation("common_ago"), false);
        __e61.nodes.addAll([new autogenerated.Text('\n                '),
            __binding57,
            new autogenerated.Text(': '),
            __e59,
            new autogenerated.Text(' '),
            __binding60,
            new autogenerated.Text('\n              ')]);
        __e65 = __e75.nodes[15];
        var __binding62 = __t.contentBind(() => Localisation.getTranslation("common_due_by"), false);
        __e64 = __html27.clone(true);
        var __binding63 = __t.contentBind(() => task.deadline, false);
        ...
        __e65.nodes.addAll([new autogenerated.Text('\n                '),
            ...
            __e64,
            new autogenerated.Text('\n              ')]);
        __e74 = __e75.nodes[17];
        __t.conditional(__e74, () => projectMap[task.projectId] != null, (__t) {
          var __e73;
          __e73 = __html28.clone(true);
          __t.conditional(__e73, () => orgMap[projectMap[task.projectId].organisationId] != null, (__t) {
            var __e68, __e71, __e72;
            __e72 = __html29.clone(true);
            var __binding66 = __t.contentBind(() => Localisation.getTranslation("common_part_of"), false);
            __e68 = __html30.clone(true);
            var __binding67 = __t.contentBind(() => projectMap[task.projectId].title, false);
            __e68.nodes.addAll([new autogenerated.Text('\n                      '),
                __binding67,
                new autogenerated.Text('\n                    ')]);
            __t.bind(() => [siteAddress, projectMap[task.projectId].id],  (__e) { __e68.href = autogenerated.sanitizeUri('${__e.newValue[0]}project/${__e.newValue[1]}/view'); }, false);
            var __binding69 = __t.contentBind(() => Localisation.getTranslation("common_for"), false);
            __e71 = __html31.clone(true);
            var __binding70 = __t.contentBind(() => orgMap[projectMap[task.projectId].organisationId].name, false);
            __e71.nodes.addAll([new autogenerated.Text('\n                      '),
                __binding70,
                new autogenerated.Text('\n                    ')]);
            __t.bind(() => [siteAddress, orgMap[projectMap[task.projectId].organisationId].id],  (__e) { __e71.href = autogenerated.sanitizeUri('${__e.newValue[0]}org/${__e.newValue[1]}/profile'); }, false);
      ...
      __e79 = __html32.clone(true);
      __t.conditional(__e79, () => moreTasks, (__t) {
        var __e78;
        __e78 = __html33.clone(true);
        var __binding77 = __t.contentBind(() => Localisation.getTranslation("index_load_more"), false);
        __e78.nodes.add(__binding77);
        __t.listen(__e78.onClick, ($event) { addTasks(); });
      __t.addAll([new autogenerated.Text('\n            '),
          __e78,
          new autogenerated.Text('\n          ')]);
      });
    ...
    __e83 = __root.nodes[5];
    __t.conditional(__e83, () => !(tasks.length > 0), (__t) {
      var __e82;
      __e82 = __html34.clone(true);
      var __binding81 = __t.contentBind(() => Localisation.getTranslation("index_no_tasks_available"), false);
