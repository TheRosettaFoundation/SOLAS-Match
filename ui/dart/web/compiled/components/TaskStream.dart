...
class TaskStream extends WebComponent with Observable 
{
  ...
  void created_autogenerated() {
    ...
    __t.conditional(__e23, () => userId > 0, (__t) {
      ...
      var __binding20 = __t.contentBind(() => Localisation.getTranslationSafe("index_2"), false);
      var __binding21 = __t.contentBind(() => Localisation.getTranslationSafe("index_3"), false);
    ...
    __t.conditional(__e82, () => tasks.length > 0, (__t) {
      ...
      __t.loop(__e78, () => tasks, ($list, $index, __t) {
        ...
        __e39 = __e77.nodes[3];
        var __binding26 = __t.contentBind(() => Localisation.getTranslationSafe("common_type"), false);
        __e29 = __html15.clone(true);
        __t.conditional(__e29, () => task.taskType == 1, (__t) {
          var __e28;
          __e28 = __html16.clone(true);
          var __binding27 = __t.contentBind(() => Localisation.getTranslationSafe("common_segmentation"), false);
        ...
        __t.conditional(__e32, () => task.taskType == 2, (__t) {
          ...
          var __binding30 = __t.contentBind(() => Localisation.getTranslationSafe("common_translation"), false);
        ...
        __t.conditional(__e35, () => task.taskType == 3, (__t) {
          ...
          var __binding33 = __t.contentBind(() => Localisation.getTranslationSafe("common_proofreading"), false);
        ...
        __t.conditional(__e38, () => task.taskType == 4, (__t) {
          ...
          var __binding36 = __t.contentBind(() => Localisation.getTranslationSafe("common_desegmentation"), false);
        ...
        __e39.nodes.addAll([__binding26,
            ...
            new autogenerated.Text('\n              ')]);
        __e44 = __e77.nodes[5];
        var __binding40 = __t.contentBind(() => Localisation.getTranslationSafe("common_from"), false);
        ...
        __e44.nodes.addAll([new autogenerated.Text('\n                '),
            ...
            new autogenerated.Text('\n              ')]);
        __e49 = __e77.nodes[7];
        var __binding45 = __t.contentBind(() => Localisation.getTranslationSafe("common_to"), false);
        ...
        var __binding55 = __t.contentBind(() => Localisation.getTranslationSafe("common_word_count"), false);
        ...
        var __binding59 = __t.contentBind(() => Localisation.getTranslationSafe("common_added"), false);
        __e61 = __html28.clone(true);
        var __binding60 = __t.contentBind(() => taskAges[task.id], false);
        __e61.nodes.add(__binding60);
        var __binding62 = __t.contentBind(() => Localisation.getTranslationSafe("common_ago"), false);
        ...
        var __binding64 = __t.contentBind(() => Localisation.getTranslationSafe("common_due_by"), false);
        ...
        __t.conditional(__e76, () => projectMap[task.projectId] != null, (__t) {
          ...
          __t.conditional(__e75, () => orgMap[projectMap[task.projectId].organisationId] != null, (__t) {
            ...
            var __binding68 = __t.contentBind(() => Localisation.getTranslationSafe("common_part_of"), false);
            ...
            var __binding71 = __t.contentBind(() => Localisation.getTranslationSafe("common_for"), false);
      ...
      __t.conditional(__e81, () => moreTasks, (__t) {
        ...
        var __binding79 = __t.contentBind(() => Localisation.getTranslationSafe("index_load_more"), false);
    ...
    __t.conditional(__e85, () => !(tasks.length > 0), (__t) {
      ...
      var __binding83 = __t.contentBind(() => Localisation.getTranslationSafe("index_no_tasks_available"), false);
