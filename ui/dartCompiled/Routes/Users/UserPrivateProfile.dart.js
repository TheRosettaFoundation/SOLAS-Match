...
Object: {"": ";",
  ...
  get$_liblib9$_location: function($receiver) {
    return this.noSuchMethod$1(this, $.createInvocationMirror("_location", "get$_liblib9$_location", 1, [], []));
  },
  ...
  set$_liblib9$_location: function($receiver, $0) {
    return this.noSuchMethod$1(this, $.createInvocationMirror("_location=", "set$_liblib9$_location", 2, [$0], []));
  },
...
_ListRangeIteratorImpl: {"": "Object;_liblib7$_source,_liblib7$_offset,_liblib7$_end",
  ...
  get$current$bailout: function(state0, t1) {
    return $.$index$asx(t1, this._liblib7$_offset);
  },
  moveNext$0: function() {
    var t1, t2;
    t1 = this._liblib7$_offset;
      ...
      case 3:
        ...
        if (t5.$lt(value, 0) === true) {
          ...
          if (t2 != null) {
            ...
            throw $.wrapException(new $.ArgumentError("Invalid UTF8 at " + $.S(t1._liblib7$_offset)));
                    ...
                    case 6:
                      if (state0 === 6 || state0 === 0 && t5.$ge(nextValue, 192) === true)
                        switch (state0) {
                          ...
                          case 6:
                            state0 = 0;
                            t1._liblib7$_offset = $.$sub$n(t2, 1);
                        }
                      break L0;
                  }
                ++j;
...
ObservableList: {"": "ListMixinWorkaround_Observable;_liblib12$_list,$$_observers,$$_changes,hashCode",
  get$length: function(_) {
    var t1 = $._activeObserver;
    if (t1 != null)
      t1._addRead$3(this, 1, "length");
    return this._liblib12$_list.length;
  },
  "+length": 0,
  set$length: function(_, value) {
    var t1, len, t2, i;
  ...
  toString$0: function(_) {
    ...
    return $.JSArray_methods.toString$0(this._liblib12$_list);
  },
  "+toString:0:0": 0,
...
_ExpressionObserver: {"": "Object;_liblib11$_id<,_expression,_liblib11$_callback,_debugName,_reads,_unobservers,_scheduled@,_liblib11$_value",
  ...
  _deliver$0: function() {
    ...
    this._observe$0();
    try {
      if ($.$eq(oldValue, this._liblib11$_value))
        return;
    } catch (exception) {
      t1 = $.unwrapException(exception);
      e = t1;
...
ObservableSet: {"": "IterableWorkaround_Observable;_liblib6$_map,_createMap,$$_observers,$$_changes,hashCode",
  contains$1: function(_, value) {
    ...
    return this._liblib6$_map.containsKey$1(value);
  },
  "+contains:1:0": 0,
  add$1: function(_, value) {
    var t1, len;
  ...
  clear$0: function(_) {
    var t1, t2, value;
    if ($.hasObservers(this)) {
      for (t1 = this._liblib6$_map, t2 = $.get$iterator$ax(t1.get$keys()); t2.moveNext$0() === true;) {
        value = t2.get$current();
        $.notifyChange(this, 10, value, value, null);
      }
      $.notifyChange(this, 1, "length", $.get$length$asx(t1), 0);
    }
    $.clear$0$ax(this._liblib6$_map);
  },
  "+clear:0:0": 0,
  get$length: function(_) {
    var t1 = $._activeObserver;
  ...
  get$iterator: function(_) {
    return new $._ObservableSetIterator(this, $.get$iterator$ax(this._liblib6$_map.get$keys()), false);
  },
  "+iterator": 0,
  ...
  toString$0: function(_) {
    var t1, value;
    if ($.observeReads())
      for (t1 = $.get$iterator$ax(this._liblib6$_map.get$keys()); t1.moveNext$0() === true;) {
        value = t1.get$current();
        $._activeObserver._addRead$3(this, 2, value);
      }
    return $.toString$0($.toSet$0$ax(this._liblib6$_map.get$keys()));
  },
  "+toString:0:0": 0,
...
_ObservableSetIterator: {"": "Object;_liblib6$_set,_liblib6$_iterator,_liblib6$_hasNext",
  moveNext$0: function() {
    var t1 = this._liblib6$_set;
    if ($.observeReads())
      $.notifyRead(t1, 1, "length");
    $.get$length$asx(t1._liblib6$_map);
  ...
  get$current: function() {
    var result, t1;
    result = this._liblib6$_iterator.get$current();
    t1 = $._activeObserver;
    if (t1 != null && this._liblib6$_hasNext === true)
      t1._addRead$3(this._liblib6$_set, 2, result);
    return result;
  },
  "+current": 0
},
...
XmlParser: {"": "Object;_xml<,_scopes,_withQuirks,_liblib9$_root",
  ...
  _parseTag$1: function(t) {
    ...
    if ($.$eq($.get$kind$x(next), 7)) {
      ...
      if (!$.$eq($.get$name$x(t1.get$first(t1)), $name))
        throw $.wrapException(new $.XmlException("Expected closing tag \"" + $.S($.get$name$x(t1.get$first(t1))) + "\" but found \"" + $.S($name) + "\" instead.", this._xml, $.get$_liblib9$_location$x(next)));
    ...
    if ($.contains$1$asx($.get$name$x(t1.get$first(t1)), ":") === true) {
      ...
      if (t1.get$first(t1).isNamespaceInScope$1(ns) !== true)
        throw $.wrapException(new $.XmlException("Namespace \"" + $.S(ns) + "\" is not declared in scope.", this._xml, $.get$_liblib9$_location$x(next)));
      next = t.next$0();
    }
    for (; next != null;) {
      ...
      switch (t2.get$kind(next)) {
        ...
        case 7:
          ...
          return;
        default:
          throw $.wrapException(new $.XmlException("Invalid xml " + $.S(next) + " found at this location.", this._xml, t2.get$_liblib9$_location(next)));
      }
      next = t.next$0();
      if (next == null)
  ...
  _parseAttribute$2: function(t, attributeName) {
    ...
    if (t3 === 6) {
      ...
      if (el.isNamespaceInScope$1(t1.attributeName_0) !== true && !result) {
        ...
        throw $.wrapException(new $.XmlException("xxNamespace \"" + $.S(t1.attributeName_0) + "\" is not declared in scope.", this._xml, $.get$_liblib9$_location$x(t1.next_1)));
      }
  ...
  _assertKind$3: function(tok, matchID, info) {
    ...
    if (tok != null) {
      ...
      t1 = false;
    if (t1)
      throw $.wrapException(new $.XmlException(msg, this._xml, $.get$_liblib9$_location$x(tok)));
  },
  "+_assertKind:2:1": 0,
...
XmlTokenizer__next_addToQueue: {"": "Closure;this_0",
  call$1: function(token) {
    var t1 = this.this_0;
    $.set$_liblib9$_location$x(token, t1.get$_i());
...
XmlToken: {"": "Object;kind>,quoteKind<,_str<,_liblib9$_location*",
  toString$0: function(_) {
    switch (this.kind) {
      case 16:
        return "(<?)";
...
$.get$_liblib9$_location$x = function(receiver) {
  return $.getInterceptor$x(receiver).get$_liblib9$_location(receiver);
};
...
$.set$_liblib9$_location$x = function(receiver, value) {
  return $.getInterceptor$x(receiver).set$_liblib9$_location(receiver, value);
};
