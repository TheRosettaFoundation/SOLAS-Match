...
namespace  {
  ...
  class PasswordReset extends \DrSlump\Protobuf\Message {
    ...
    public $email_type = \EmailMessage\Type::PasswordReset;
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, '.PasswordReset');
      ...
      $f->default   = \EmailMessage\Type::PasswordReset;
