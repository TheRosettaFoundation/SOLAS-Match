...
-- Dumping data for table Solas-Match-Dev.ArchivedProjects: ~0 rows (approximately)
/*!40000 ALTER TABLE `ArchivedProjects` DISABLE KEYS */;
/*!40000 ALTER TABLE `ArchivedProjects` ENABLE KEYS */;
...
-- Dumping data for table Solas-Match-Dev.ArchivedProjectsMetaData: ~0 rows (approximately)
/*!40000 ALTER TABLE `ArchivedProjectsMetaData` DISABLE KEYS */;
...
-- Dumping structure for table manuel-test.Badges
...
-- Dumping data for table manuel-test.Badges: ~3 rows (approximately)
...
-- Dumping structure for table manuel-test.Countries
...
-- Dumping structure for table manuel-test.Languages
...
-- Dumping structure for table manuel-test.OrganisationMembers
...
-- Dumping structure for table manuel-test.Organisations
...
-- Dumping structure for table manuel-test.OrgRequests
...
-- Dumping structure for table manuel-test.PasswordResetRequests
...
-- Dumping data for table Solas-Match-Dev.Statistics: ~0 rows (approximately)
/*!40000 ALTER TABLE `Statistics` DISABLE KEYS */;
/*!40000 ALTER TABLE `Statistics` ENABLE KEYS */;

-- Dumping structure for table manuel-test.Tags
...
-- Dumping data for table Solas-Match-Dev.TaskClaims: ~0 rows (approximately)
...
-- Dumping data for table Solas-Match-Dev.TaskPrerequisites: ~0 rows (approximately)
/*!40000 ALTER TABLE `TaskPrerequisites` DISABLE KEYS */;
/*!40000 ALTER TABLE `TaskPrerequisites` ENABLE KEYS */;


-- Dumping structure for table manuel-test.TaskFileVersions
...
-- Dumping data for table Solas-Match-Dev.TaskStatus: ~4 rows (approximately)
/*!40000 ALTER TABLE `TaskStatus` DISABLE KEYS */;
REPLACE INTO `TaskStatus` (`id`, `name`) VALUES
	(4, 'complete'),
	(3, 'inProgress'),
	(2, 'pendingClaim'),
	(1, 'waitingForPrerequecs');
...
-- Dumping data for table Solas-Match-Dev.TaskTypes: ~2 rows (approximately)
...
-- Dumping structure for table manuel-test.UserBadges
...
-- Dumping structure for table manuel-test.UserNotifications
...
-- Dumping structure for table manuel-test.Users
...
-- Dumping structure for table manuel-test.UserTags
...
-- Dumping structure for table manuel-test.UserTaskScores
...
-- Dumping structure for procedure manuel-test.addBadge
...
-- Dumping structure for procedure manuel-test.addPasswordResetRequest
...
-- Dumping structure for procedure manuel-test.assignBadge
...
-- Dumping structure for procedure manuel-test.badgeInsertAndUpdate
...
-- Dumping structure for procedure manuel-test.claimTask
...
-- Dumping structure for procedure manuel-test.deleteBadge
...
-- Dumping structure for procedure manuel-test.deleteOrg
...
-- Dumping structure for procedure manuel-test.deleteTag
...
-- Dumping structure for procedure manuel-test.deleteTask
...
-- Dumping structure for procedure manuel-test.findOrganisation
...
-- Dumping structure for procedure manuel-test.findOrganisationsUserBelongsTo
...
-- Dumping structure for procedure manuel-test.getArchivedTasks
...
-- Dumping structure for procedure manuel-test.getBadge
...
-- Dumping structure for procedure manuel-test.getCountries
...
-- Dumping structure for procedure manuel-test.getCountry
...
-- Dumping structure for procedure manuel-test.getLanguage
...
-- Dumping structure for procedure manuel-test.getLanguages
...
-- Dumping structure for procedure manuel-test.getLatestFileVersion
...
-- Dumping structure for procedure manuel-test.getLCID
...
-- Dumping structure for procedure manuel-test.getMembershipRequests
...
-- Dumping structure for procedure manuel-test.getOrg
...
-- Dumping structure for procedure manuel-test.getOrgByUser
...
-- Dumping structure for procedure manuel-test.getOrgMembers
...
-- Dumping structure for procedure manuel-test.getPasswordResetRequests
...
-- Dumping structure for procedure manuel-test.getSubscribedUsers
...
-- Dumping structure for procedure manuel-test.getTag
...
-- Dumping structure for procedure manuel-test.getTaggedTasks
...
-- Dumping structure for procedure manuel-test.getTasksByOrgIDs
...
-- Dumping structure for procedure manuel-test.getTaskTags
...
-- Dumping structure for procedure manuel-test.getTaskTranslator
...
-- Dumping structure for procedure manuel-test.getTopTags
...
-- Dumping structure for procedure manuel-test.getTotalArchivedTasks
...
-- Dumping structure for procedure manuel-test.getTotalClaimedTasks
...
-- Dumping structure for procedure manuel-test.getTotalOrgs
...
-- Dumping structure for procedure manuel-test.getTotalTasks
...
-- Dumping structure for procedure manuel-test.getTotalUnclaimedTasks
...
-- Dumping structure for procedure manuel-test.getTotalUsers
...
-- Dumping structure for procedure manuel-test.getUser
...
-- Dumping structure for procedure manuel-test.getUserArchivedTasks
...
-- Dumping structure for procedure manuel-test.getUserBadges
...
-- Dumping structure for procedure manuel-test.getUserNotifications
...
-- Dumping structure for procedure manuel-test.getUsersWithBadge
...
-- Dumping structure for procedure manuel-test.getUserTags
...
-- Dumping structure for procedure manuel-test.getUserTasks
...
-- Dumping structure for procedure manuel-test.getUserTaskScore
...
-- Dumping structure for procedure manuel-test.hasUserClaimedTask
...
-- Dumping structure for procedure manuel-test.logFileDownload
...
-- Dumping structure for procedure manuel-test.organisationInsertAndUpdate
...
-- Dumping structure for procedure manuel-test.recordFileUpload
...
-- Dumping structure for procedure manuel-test.removeMembershipRequest
...
-- Dumping structure for procedure manuel-test.removePasswordResetRequest
...
-- Dumping structure for procedure manuel-test.removeUserNotification
...
-- Dumping structure for procedure manuel-test.removeUserTag
...
-- Dumping structure for procedure manuel-test.requestMembership
...
-- Dumping structure for procedure manuel-test.revokeMembership
...
-- Dumping structure for procedure manuel-test.saveUserTaskScore
...
-- Dumping structure for procedure manuel-test.searchForOrg
...
-- Dumping structure for procedure manuel-test.storeTagLinks
...
-- Dumping structure for procedure manuel-test.tagInsert
...
-- Dumping structure for procedure manuel-test.taskDownloadCount
...
-- Dumping structure for procedure manuel-test.userNotificationsInsertAndUpdate
...
-- Dumping structure for trigger manuel-test.defaultUserName
...
-- Dumping structure for trigger manuel-test.removeTaskInfo
...
-- Dumping structure for trigger manuel-test.validateHomepageInsert
...
-- Dumping structure for trigger manuel-test.validateHomepageUpdate
